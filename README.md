...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 505,607 | 🐛 106 | 📅 2026-09-02
...
*Please read the [contribution guidelines](contributing.md) before contributing. Please add your favourite NLP resource by raising a [pull request](https://github.com/keonkim/awesome-nlp/pulls) ⭐ 18,989 | 🐛 17 | 📅 2026-09-07*
...
* [Hands-On NLTK Tutorial](https://github.com/hb20007/hands-on-nltk-tutorial) ⭐ 571 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-04-17 - NLTK Tutorials, Jupyter notebooks
...
* [Natural Language Processing](https://github.com/jacobeisenstein/gt-nlp-class) ⭐ 5,084 | 🐛 2 | 🌐 TeX | 📅 2023-01-31 - free, NLP notes by Dr. Jacob Eisenstein at GeorgiaTech
...
* <a id="python"> **Python** - Python NLP Libraries</a> | [Back to Top](#contents)
  * [Transformers](https://github.com/huggingface/transformers) ⭐ 165,294 | 🐛 2,428 | 🌐 Python | 📅 2026-09-13 - Natural Language Processing for TensorFlow 2.0 and PyTorch.
  * [spaCy](https://github.com/explosion/spaCy) ⭐ 33,896 | 🐛 240 | 🌐 Python | 📅 2026-08-24 - Industrial strength NLP with Python and Cython :+1:
  ...
  * [Haystack](https://github.com/deepset-ai/haystack) ⭐ 26,494 | 🐛 143 | 🌐 Python | 📅 2026-09-13 - End-to-end Python framework for building natural language search interfaces to data. Leverages Transformers and the State-of-the-Art of NLP. Supports DPR, Elasticsearch, HuggingFace’s Modelhub, and much more!
  * [HuggingFace Datasets](https://github.com/huggingface/datasets) ⭐ 21,967 | 🐛 1,365 | 🌐 Python | 📅 2026-09-11 - standardized loaders and processing for thousands of NLP datasets.
  * [Sentence-Transformers](https://github.com/UKPLab/sentence-transformers) ⭐ 19,093 | 🐛 1,299 | 🌐 Python | 📅 2026-09-11 - sentence/document embeddings, semantic search, and re-ranking; current standard for retrieval-style NLP.
  ...
  * [Tokenizers](https://github.com/huggingface/tokenizers) ⭐ 11,034 | 🐛 260 | 🌐 Rust | 📅 2026-09-11 - Tokenizers optimized for Research and Production.
  ...
  * [Argilla](https://github.com/argilla-io/argilla) ⭐ 5,105 | 🐛 34 | 🌐 Python | 📅 2026-09-07 - open-source data annotation and feedback collection platform for LLM and NLP datasets.
  * [Snips NLU](https://github.com/snipsco/snips-nlu) ⭐ 3,973 | 🐛 67 | 🌐 Python | 📅 2023-05-22 - A production ready library for intent parsing
  * [TextAttack](https://github.com/QData/TextAttack) ⭐ 3,475 | 🐛 20 | 🌐 Python | 📅 2026-08-15 - Adversarial attacks, adversarial training, and data augmentation in NLP
  ...
  * [Word Forms](https://github.com/gutfeeling/word_forms) ⭐ 629 | 🐛 4 | 🌐 Python | 📅 2021-06-24 - Word forms can accurately generate all possible forms of an English word
  ...
  * [yasbd-lib](https://github.com/speedyk-005/yasbd-lib) ⭐ 29 | 🐛 15 | 🌐 Python | 📅 2026-09-11 - High-accuracy, rule-based sentence boundary detector (SBD). Drop-in pysbd adapter, streaming APIs, CLI, and a spaCy component across 39+ languages.
...
- <a id="c++">**C++** - C++ Libraries</a> | [Back to Top](#contents)
  ...
  * [MeTA](https://github.com/meta-toolkit/meta) ⭐ 717 | 🐛 56 | 🌐 C++ | 📅 2023-04-17 - ModErn Text Analysis: a C++ data sciences toolkit for mining big text data.
...
- <a id="go">**Go**</a> | [Back to Top](#contents)
  ...
  * [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,644 | 🐛 0 | 🌐 Go | 📅 2026-07-20 - Go implementation of the jieba Chinese word segmentation algorithm.
...
- <a id="NLP++">**NLP++** - NLP++ Language</a> | [Back to Top](#contents)
  * [nlp-engine](https://github.com/VisualText/nlp-engine) ⭐ 24 | 🐛 82 | 🌐 C++ | 📅 2026-09-11 - NLP++ engine to run NLP++ code on Linux including a full English parser
...
* [Label Studio](https://github.com/HumanSignal/label-studio) ⭐ 28,252 | 🐛 944 | 🌐 TypeScript | 📅 2026-09-11 - open-core multi-modal labeling platform; widely used for NLP labeling.
...
* [Argilla](https://github.com/argilla-io/argilla) ⭐ 5,105 | 🐛 34 | 🌐 Python | 📅 2026-09-07 - open-source platform for collecting human feedback, building NLP and LLM datasets, and curating preference data.
* [Potato](https://github.com/davidjurgens/potato) ⭐ 421 | 🐛 4 | 🌐 Python | 📅 2026-09-13 - Free, open-source annotation tool covering 21+ task types (classification, span, coreference, entity linking, agent trace evaluation) with built-in MACE quality control, attention checks, AI-assisted labeling, and 300+ example tasks.
...
Modern sentence and document embeddings: see [Retrieval for NLP](#retrieval-for-nlp) (Sentence-Transformers, E5, BGE-M3, Nomic, GritLM) and [MTEB](https://github.com/embeddings-benchmark/mteb) ⭐ 3,421 | 🐛 327 | 🌐 Python | 📅 2026-09-13 for current leaderboards.

### Tokenization, Morphology, and Segmentation

[Back to Top](#contents)

* [SentencePiece](https://github.com/google/sentencepiece) ⭐ 12,074 | 🐛 6 | 🌐 C++ | 📅 2026-09-12 - language-agnostic subword tokenization.

* [SentencePiece](https://github.com/google/sentencepiece) ⭐ 12,074 | 🐛 6 | 🌐 C++ | 📅 2026-09-12 - language-agnostic subword tokenization (BPE and Unigram).

* [Tokenizers](https://github.com/huggingface/tokenizers) ⭐ 11,034 | 🐛 260 | 🌐 Rust | 📅 2026-09-11 - fast Rust implementations of BPE, WordPiece, Unigram.
...
* [SetFit](https://github.com/huggingface/setfit) ⭐ 2,805 | 🐛 155 | 🌐 Jupyter Notebook | 📅 2026-09-08 - few-shot text classification without prompts.
...
* [BERTopic](https://github.com/MaartenGr/BERTopic) ⭐ 7,832 | 🐛 472 | 🌐 Python | 📅 2026-09-09 - clustering-based topic modeling on top of contextual embeddings; common modern default.
* [Top2Vec](https://github.com/ddangelov/Top2Vec) ⭐ 3,106 | 🐛 84 | 🌐 Python | 📅 2024-11-14 - jointly learns topic and document vectors.
...
* [Marian NMT](https://github.com/marian-nmt/marian) ⭐ 1,471 | 🐛 97 | 🌐 C++ | 📅 2023-08-25 - efficient C++ NMT framework.
...
* [BGE](https://github.com/FlagOpen/FlagEmbedding) ⭐ 12,154 | 🐛 908 | 🌐 Python | 📅 2026-08-24 and [BGE-M3](https://arxiv.org/abs/2402.03216) (2024) - multilingual, multi-functionality embeddings; top of MTEB across languages.
...
* [Whisper](https://github.com/openai/whisper) ⭐ 108,980 | 🐛 148 | 🌐 Python | 📅 2026-08-31 - multilingual ASR; the modern open default.
* [Coqui TTS](https://github.com/coqui-ai/TTS) ⭐ 46,004 | 🐛 3 | 🌐 Python | 📅 2024-08-16 and [VieNeu-TTS](https://github.com/pnnbao97/VieNeu-TTS) ⭐ 2,554 | 🐛 12 | 🌐 Python | 📅 2026-09-09 - open TTS.
* [FunASR](https://github.com/modelscope/FunASR) ⭐ 20,302 | 🐛 30 | 🌐 Python | 📅 2026-09-10 - industrial-grade ASR toolkit; 170× realtime on GPU, 50+ languages, built-in VAD, punctuation, speaker diarization, and emotion detection. Includes non-autoregressive SenseVoice and LLM-based Fun-ASR-Nano models.
* [SeamlessM4T](https://github.com/facebookresearch/seamless_communication) ⭐ 11,854 | 🐛 252 | 🌐 Jupyter Notebook | 📅 2026-09-08 - unified speech and text translation.
...
* [nlp-datasets](https://github.com/niderhoff/nlp-datasets) ⭐ 5,997 | 🐛 12 | 📅 2023-02-15 - large collection of NLP datasets.
...
* [Dolma](https://github.com/allenai/dolma) ⭐ 1,543 | 🐛 26 | 🌐 Python | 📅 2026-08-24 (AI2, 2023-2024) - 3T-token open pretraining corpus with documented filtering pipeline.
...
* [MTEB](https://github.com/embeddings-benchmark/mteb) ⭐ 3,421 | 🐛 327 | 🌐 Python | 📅 2026-09-13 - Massive Text Embedding Benchmark; standard for sentence/document encoders.
...
* [LM Evaluation Harness](https://github.com/EleutherAI/lm-evaluation-harness) ⭐ 13,963 | 🐛 978 | 🌐 Python | 📅 2026-09-10 - unified framework for LM benchmark evaluation.
* [BIG-bench](https://github.com/google/BIG-bench) ⚠️ Archived - 200+ tasks probing language model capabilities.
* [MMLU](https://github.com/hendrycks/test) ⭐ 1,616 | 🐛 16 | 🌐 Python | 📅 2023-05-28 - multitask knowledge evaluation across 57 subjects.
...
* [RAGAS](https://github.com/explodinggradients/ragas) ⭐ 15,721 | 🐛 587 | 🌐 Python | 📅 2026-02-24 - reference-free evaluation for RAG and QA pipelines.
...
* [GTE](https://huggingface.co/thenlper/gte-base), [BGE](https://github.com/FlagOpen/FlagEmbedding) ⭐ 12,154 | 🐛 908 | 🌐 Python | 📅 2026-08-24, and [Stella](https://huggingface.co/dunzhang/stella_en_1.5B_v5) - compact text embedding models near the top of MTEB.
* [SetFit](https://github.com/huggingface/setfit) ⭐ 2,805 | 🐛 155 | 🌐 Jupyter Notebook | 📅 2026-09-08 - few-shot text classification without prompts.
...
* [GGUF / llama.cpp](https://github.com/ggerganov/llama.cpp) ⭐ 128,075 | 🐛 2,469 | 🌐 C++ | 📅 2026-09-13 - portable quantized inference.
* [vLLM](https://github.com/vllm-project/vllm) ⭐ 91,614 | 🐛 7,914 | 🌐 Python | 📅 2026-09-13 - PagedAttention-based high-throughput LM serving.
* [SGLang](https://github.com/sgl-project/sglang) ⭐ 35,887 | 🐛 5,297 | 🌐 Python | 📅 2026-09-13 - structured generation and efficient serving.
...
* [PEFT](https://github.com/huggingface/peft) ⭐ 21,666 | 🐛 86 | 🌐 Python | 📅 2026-09-11 - HuggingFace library bundling LoRA, prefix tuning, IA3, and others.
...
* [TRL](https://github.com/huggingface/trl) ⭐ 19,296 | 🐛 310 | 🌐 Python | 📅 2026-09-13 - reference library for SFT, DPO, GRPO, and RLHF.
...
* [CAMeL Tools](https://github.com/CAMeL-Lab/camel_tools) ⭐ 578 | 🐛 35 | 🌐 Python | 📅 2026-06-08 - Python toolkit for Arabic NLP including dialect ID, morphology, NER.
...
* [AraBERT](https://github.com/aub-mind/arabert) ⭐ 729 | 🐛 2 | 🌐 Python | 📅 2022-10-17 - Arabic BERT family.
* [AraELECTRA](https://aclanthology.org/2021.wanlp-1.20/) - efficient Arabic pretraining (released alongside [AraBERT](https://github.com/aub-mind/arabert) ⭐ 729 | 🐛 2 | 🌐 Python | 📅 2022-10-17).
...
* [HanLP](https://github.com/hankcs/HanLP) ⭐ 36,489 | 🐛 12 | 🌐 Python | 📅 2025-11-15 - multilingual NLP library with strong Chinese support.
* [jieba](https://github.com/fxsjy/jieba#jieba-1) ⭐ 35,150 | 🐛 700 | 🌐 Python | 📅 2024-08-21 - Python package for Chinese word segmentation.
...
* [DeepSeek-V3](https://github.com/deepseek-ai/DeepSeek-V3) ⭐ 104,437 | 🐛 220 | 🌐 Python | 📅 2025-08-28 - efficient open MoE model with strong Chinese.
* [Qwen 2.5 / Qwen 3](https://github.com/QwenLM/Qwen3) ⭐ 27,611 | 🐛 67 | 🌐 Python | 📅 2026-01-09 - Alibaba's open Chinese-strong LM family.
* [ChatGLM3 / GLM-4](https://github.com/THUDM/ChatGLM3) ⭐ 13,655 | 🐛 36 | 🌐 Python | 📅 2025-01-13 - Tsinghua's bilingual Chinese-English LMs.
...
* [Baichuan 2](https://github.com/baichuan-inc/Baichuan2) ⭐ 4,084 | 🐛 281 | 🌐 Python | 📅 2024-11-08 - open Chinese LM.
* [MacBERT](https://github.com/ymcui/MacBERT) ⭐ 721 | 🐛 0 | 📅 2026-04-19 - improved Chinese BERT with MLM-as-correction pretraining.

### Anthology

* [funNLP](https://github.com/fighting41love/funNLP) ⭐ 83,083 | 🐛 53 | 🌐 Python | 📅 2024-05-10 - large collection of Chinese NLP tools and resources.
...
* [Alpino](https://github.com/rug-compling/alpino) ⭐ 31 | 🐛 2 | 🌐 Prolog | 📅 2026-09-09 - dependency parser for Dutch (also does POS tagging and lemmatization).
...
* [Kiwi](https://github.com/bab2min/Kiwi) ⭐ 779 | 🐛 16 | 🌐 C++ | 📅 2026-09-13 - fast Korean morphological analyzer.
* [kss](https://github.com/hyunwoongko/kss) ⭐ 470 | 🐛 6 | 🌐 Python | 📅 2025-11-13 - Korean sentence splitter.
* [Garu](https://github.com/ongjin/garu) ⭐ 176 | 🐛 0 | 🌐 Python | 📅 2026-09-07 - browser-native Korean morphological analyzer running fully client-side via WebAssembly (1MB model, offline, MIT).
...
* [Hazm](https://github.com/roshan-research/hazm) ⭐ 1,421 | 🐛 9 | 🌐 Python | 📅 2026-04-01 - Persian NLP toolkit.
...
* [ParsBERT](https://github.com/hooshvare/parsbert) ⭐ 429 | 🐛 12 | 🌐 Jupyter Notebook | 📅 2023-06-12 - Persian BERT.
...
* [Portuguese-nlp](https://github.com/ajdavidl/Portuguese-NLP) ⭐ 372 | 🐛 1 | 📅 2026-06-25 - curated list of Portuguese NLP resources and tools.
...
* [VieNeu-TTS](https://github.com/pnnbao97/VieNeu-TTS) ⭐ 2,554 | 🐛 12 | 🌐 Python | 📅 2026-09-09 - on-device Vietnamese text-to-speech with voice cloning.
* [underthesea](https://github.com/undertheseanlp/underthesea) ⭐ 1,807 | 🐛 37 | 🌐 Python | 📅 2026-09-13 - Vietnamese NLP toolkit.
...
* [awesome-llm](https://github.com/Hannibal046/Awesome-LLM) ⭐ 27,363 | 🐛 455 | 📅 2025-07-31 - general-purpose large language model resources.
* [awesome-mlops](https://github.com/visenger/awesome-mlops) ⭐ 14,194 | 🐛 46 | 📅 2024-11-21 - production ML, including LLM serving.
* [awesome-generative-ai](https://github.com/steven2358/awesome-generative-ai) ⭐ 12,632 | 🐛 663 | 📅 2026-09-09 - generative AI across modalities.
* [awesome-prompt-engineering](https://github.com/promptslab/Awesome-Prompt-Engineering) ⭐ 6,329 | 🐛 114 | 🌐 TypeScript | 📅 2026-09-13 - prompting techniques and template libraries.
* [awesome-rag](https://github.com/Danielskry/Awesome-RAG) ⭐ 1,361 | 🐛 100 | 📅 2026-07-09 - retrieval-augmented generation systems and tooling.
