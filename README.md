...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 507,710 | 🐛 106 | 📅 2026-09-02
...
*Please read the [contribution guidelines](contributing.md) before contributing. Please add your favourite NLP resource by raising a [pull request](https://github.com/keonkim/awesome-nlp/pulls) ⭐ 19,013 | 🐛 18 | 📅 2026-09-07*
...
* [Deep Natural Language Processing](https://github.com/oxford-cs-deepnlp-2017/lectures) ⭐ 15,854 | 🐛 12 | 📅 2023-07-02 - Lectures series from Oxford
* [Deep NLP Course](https://github.com/yandexdataschool/nlp_course) ⭐ 10,688 | 🐛 8 | 🌐 Jupyter Notebook | 📅 2026-09-18 by Yandex Data School, covering important ideas from text embedding to machine translation including sequence modeling, language models and so on.
...
* [Machine Learning University - Accelerated Natural Language Processing](https://www.youtube.com/playlist?list=PL8P_Z6C4GcuWfAq8Pt6PBYlck4OprHXsw) - Lectures go from introduction to NLP and text processing to Recurrent Neural Networks and Transformers.
  Material can be found [here](https://github.com/aws-samples/aws-machine-learning-university-accelerated-nlp) ⭐ 2,435 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2024-10-13.
...
* <a id="node-js">**Node.js and Javascript** - Node.js Libaries for NLP</a> | [Back to Top](#contents)
  * [NLP Compromise](https://github.com/spencermountain/compromise) ⭐ 12,158 | 🐛 119 | 🌐 JavaScript | 📅 2026-09-19 - Natural Language processing in the browser
  ...
  * [NLP.js](https://github.com/axa-group/nlp.js) ⭐ 6,586 | 🐛 114 | 🌐 JavaScript | 📅 2025-01-09 - An NLP library for building bots
...
* <a id="python"> **Python** - Python NLP Libraries</a> | [Back to Top](#contents)
  * [Transformers](https://github.com/huggingface/transformers) ⭐ 166,331 | 🐛 2,416 | 🌐 Python | 📅 2026-09-19 - Natural Language Processing for TensorFlow 2.0 and PyTorch.
  * [spaCy](https://github.com/explosion/spaCy) ⭐ 33,912 | 🐛 245 | 🌐 Python | 📅 2026-08-24 - Industrial strength NLP with Python and Cython :+1:
  ...
  * [Haystack](https://github.com/deepset-ai/haystack) ⭐ 26,550 | 🐛 168 | 🌐 Python | 📅 2026-09-19 - End-to-end Python framework for building natural language search interfaces to data. Leverages Transformers and the State-of-the-Art of NLP. Supports DPR, Elasticsearch, HuggingFace’s Modelhub, and much more!
  * [HuggingFace Datasets](https://github.com/huggingface/datasets) ⭐ 21,994 | 🐛 1,387 | 🌐 Python | 📅 2026-09-17 - standardized loaders and processing for thousands of NLP datasets.
  * [Sentence-Transformers](https://github.com/UKPLab/sentence-transformers) ⭐ 19,102 | 🐛 1,303 | 🌐 Python | 📅 2026-09-18 - sentence/document embeddings, semantic search, and re-ranking; current standard for retrieval-style NLP.
  * [Flair](https://github.com/zalandoresearch/flair) ⭐ 14,388 | 🐛 31 | 🌐 Python | 📅 2025-10-27 - A very simple framework for state-of-the-art multilingual NLP built on PyTorch. Includes BERT, ELMo and Flair embeddings.
  ...
  * [Tokenizers](https://github.com/huggingface/tokenizers) ⭐ 11,047 | 🐛 219 | 🌐 Rust | 📅 2026-09-18 - Tokenizers optimized for Research and Production.
  * [TextBlob](http://textblob.readthedocs.org/) - Providing a consistent API for diving into common natural language processing (NLP) tasks. Stands on the giant shoulders of [Natural Language Toolkit (NLTK)](https://www.nltk.org/) and [Pattern](https://github.com/clips/pattern) ⭐ 8,861 | 🐛 179 | 🌐 Python | 📅 2026-08-05, and plays nicely with both :+1:
  * [Stanza](https://github.com/stanfordnlp/stanza) ⭐ 7,880 | 🐛 96 | 🌐 Python | 📅 2026-09-18 - Stanford NLP's Python toolkit for tokenization, POS, lemma, dependency parsing, and NER across 70+ languages.
  * [Argilla](https://github.com/argilla-io/argilla) ⭐ 5,113 | 🐛 34 | 🌐 Python | 📅 2026-09-14 - open-source data annotation and feedback collection platform for LLM and NLP datasets.
  * [Snips NLU](https://github.com/snipsco/snips-nlu) ⭐ 3,973 | 🐛 67 | 🌐 Python | 📅 2023-05-22 - A production ready library for intent parsing
  * [TextAttack](https://github.com/QData/TextAttack) ⭐ 3,473 | 🐛 20 | 🌐 Python | 📅 2026-08-15 - Adversarial attacks, adversarial training, and data augmentation in NLP
  ...
  * [HuggingFace Evaluate](https://github.com/huggingface/evaluate) ⭐ 2,483 | 🐛 311 | 🌐 Python | 📅 2026-09-17 - reference implementations for NLP metrics.
  ...
  * [sacrebleu](https://github.com/mjpost/sacrebleu) ⭐ 1,258 | 🐛 23 | 🌐 Python | 📅 2026-08-20 - reproducible BLEU/chrF/TER scoring for machine translation.
  ...
  * [yasbd-lib](https://github.com/speedyk-005/yasbd-lib) ⭐ 29 | 🐛 6 | 🌐 Python | 📅 2026-09-18 - High-accuracy, rule-based sentence boundary detector (SBD). Drop-in pysbd adapter, streaming APIs, CLI, and a spaCy component across 39+ languages.
...
- <a id="scala">**Scala** - Scala NLP Libraries</a> | [Back to Top](#contents)
  * [Spark NLP](https://github.com/JohnSnowLabs/spark-nlp) ⭐ 4,159 | 🐛 34 | 🌐 Scala | 📅 2026-09-18 - Spark NLP is a natural language processing library built on top of Apache Spark ML that provides simple, performant & accurate NLP annotations for machine learning pipelines that scale easily in a distributed environment.
...
- <a id="go">**Go**</a> | [Back to Top](#contents)
  ...
  * [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,645 | 🐛 0 | 🌐 Go | 📅 2026-07-20 - Go implementation of the jieba Chinese word segmentation algorithm.
  * [kagome](https://github.com/ikawaha/kagome) ⭐ 982 | 🐛 0 | 🌐 Go | 📅 2026-09-19 - Japanese morphological analyzer written in pure Go.
...
- <a id="ruby">**Ruby**</a> | [Back to Top](#contents)
  ...
  * [Practical Natural Language Processing done in Ruby](https://github.com/arbox/nlp-with-ruby) ⭐ 1,075 | 🐛 8 | 🌐 Ruby | 📅 2023-06-27
...
- <a id="NLP++">**NLP++** - NLP++ Language</a> | [Back to Top](#contents)
  * [nlp-engine](https://github.com/VisualText/nlp-engine) ⭐ 24 | 🐛 82 | 🌐 C++ | 📅 2026-09-15 - NLP++ engine to run NLP++ code on Linux including a full English parser
...
* [Label Studio](https://github.com/HumanSignal/label-studio) ⭐ 28,296 | 🐛 950 | 🌐 TypeScript | 📅 2026-09-19 - open-core multi-modal labeling platform; widely used for NLP labeling.
* [doccano](https://github.com/chakki-works/doccano) ⭐ 10,771 | 🐛 398 | 🌐 Python | 📅 2026-04-14 - doccano is free, open-source, and provides annotation features for text classification, sequence labeling and sequence to sequence
* [Argilla](https://github.com/argilla-io/argilla) ⭐ 5,113 | 🐛 34 | 🌐 Python | 📅 2026-09-14 - open-source platform for collecting human feedback, building NLP and LLM datasets, and curating preference data.
* [Potato](https://github.com/davidjurgens/potato) ⭐ 423 | 🐛 4 | 🌐 Python | 📅 2026-09-19 - Free, open-source annotation tool covering 21+ task types (classification, span, coreference, entity linking, agent trace evaluation) with built-in MACE quality control, attention checks, AI-assisted labeling, and 300+ example tasks.
...
* [Shoonya](https://github.com/AI4Bharat/Shoonya-Backend) ⭐ 28 | 🐛 47 | 🌐 Python | 📅 2026-09-15 - Shoonya is free and open source data annotation platform with wide varities of organization and workspace level management system. Shoonya is data agnostic, can be used by teams to annotate data with various level of verification stages at scale.
...
Modern sentence and document embeddings: see [Retrieval for NLP](#retrieval-for-nlp) (Sentence-Transformers, E5, BGE-M3, Nomic, GritLM) and [MTEB](https://github.com/embeddings-benchmark/mteb) ⭐ 3,427 | 🐛 322 | 🌐 Python | 📅 2026-09-19 for current leaderboards.

### Tokenization, Morphology, and Segmentation

[Back to Top](#contents)

* [SentencePiece](https://github.com/google/sentencepiece) ⭐ 12,088 | 🐛 6 | 🌐 C++ | 📅 2026-09-16 - language-agnostic subword tokenization.

* [SentencePiece](https://github.com/google/sentencepiece) ⭐ 12,088 | 🐛 6 | 🌐 C++ | 📅 2026-09-16 - language-agnostic subword tokenization (BPE and Unigram).

* [Tokenizers](https://github.com/huggingface/tokenizers) ⭐ 11,047 | 🐛 219 | 🌐 Rust | 📅 2026-09-18 - fast Rust implementations of BPE, WordPiece, Unigram.

* [Stanza](https://github.com/stanfordnlp/stanza) ⭐ 7,880 | 🐛 96 | 🌐 Python | 📅 2026-09-18 - tokenization, lemma, and morphology for 70+ languages.

* [UDPipe](https://github.com/ufal/udpipe) ⭐ 419 | 🐛 15 | 🌐 C++ | 📅 2026-06-11 - tokenization, tagging, lemmatization, parsing for Universal Dependencies.
...
* [spaCy](https://spacy.io/) and [Stanza](https://github.com/stanfordnlp/stanza) ⭐ 7,880 | 🐛 96 | 🌐 Python | 📅 2026-09-18 - production parsers across many languages.
...
* [Flair](https://github.com/flairNLP/flair) ⭐ 14,388 | 🐛 31 | 🌐 Python | 📅 2025-10-27 - contextual string embeddings, strong NER across languages.
...
* [SetFit](https://github.com/huggingface/setfit) ⭐ 2,809 | 🐛 154 | 🌐 Jupyter Notebook | 📅 2026-09-18 - few-shot text classification without prompts.
...
* [BERTopic](https://github.com/MaartenGr/BERTopic) ⭐ 7,843 | 🐛 473 | 🌐 Python | 📅 2026-09-18 - clustering-based topic modeling on top of contextual embeddings; common modern default.
...
* [sacrebleu](https://github.com/mjpost/sacrebleu) ⭐ 1,258 | 🐛 23 | 🌐 Python | 📅 2026-08-20 - reproducible BLEU/chrF/TER scoring.
...
* [BGE](https://github.com/FlagOpen/FlagEmbedding) ⭐ 12,176 | 🐛 910 | 🌐 Python | 📅 2026-08-24 and [BGE-M3](https://arxiv.org/abs/2402.03216) (2024) - multilingual, multi-functionality embeddings; top of MTEB across languages.
...
* [Whisper](https://github.com/openai/whisper) ⭐ 109,360 | 🐛 150 | 🌐 Python | 📅 2026-08-31 - multilingual ASR; the modern open default.
* [Coqui TTS](https://github.com/coqui-ai/TTS) ⭐ 46,028 | 🐛 3 | 🌐 Python | 📅 2024-08-16 and [VieNeu-TTS](https://github.com/pnnbao97/VieNeu-TTS) ⭐ 2,631 | 🐛 13 | 🌐 Python | 📅 2026-09-18 - open TTS.
* [FunASR](https://github.com/modelscope/FunASR) ⭐ 20,428 | 🐛 35 | 🌐 Python | 📅 2026-09-19 - industrial-grade ASR toolkit; 170× realtime on GPU, 50+ languages, built-in VAD, punctuation, speaker diarization, and emotion detection. Includes non-autoregressive SenseVoice and LLM-based Fun-ASR-Nano models.
* [SeamlessM4T](https://github.com/facebookresearch/seamless_communication) ⭐ 11,857 | 🐛 252 | 🌐 Jupyter Notebook | 📅 2026-09-08 - unified speech and text translation.
...
* [RedPajama / RedPajama-V2](https://github.com/togethercomputer/RedPajama-Data) ⭐ 4,984 | 🐛 43 | 🌐 Python | 📅 2026-06-03 (2023-2024) - reproductions of LLaMA pretraining data; V2 is 30T tokens with quality signals.
...
* [NLP-Cube](https://github.com/adobe/NLP-Cube) ⭐ 563 | 🐛 4 | 🌐 HTML | 📅 2024-11-03 : Natural Language Processing Pipeline - Sentence Splitting, Tokenization, Lemmatization, Part-of-speech Tagging and Dependency Parsing. New platform, written in Python with Dynet 2.0. Offers standalone (CLI/Python bindings) and server functionality (REST API).
* [UDPipe](https://github.com/ufal/udpipe) ⭐ 419 | 🐛 15 | 🌐 C++ | 📅 2026-06-11 is a trainable pipeline for tokenizing, tagging, lemmatizing and parsing Universal Treebanks and other CoNLL-U files. Primarily written in C++, offers a fast and reliable solution for multilingual NLP processing.
...
* [MTEB](https://github.com/embeddings-benchmark/mteb) ⭐ 3,427 | 🐛 322 | 🌐 Python | 📅 2026-09-19 - Massive Text Embedding Benchmark; standard for sentence/document encoders.
* [BEIR](https://github.com/beir-cellar/beir) ⭐ 2,293 | 🐛 83 | 🌐 Python | 📅 2025-10-16 - heterogeneous IR benchmark for retrieval models.
...
* [LM Evaluation Harness](https://github.com/EleutherAI/lm-evaluation-harness) ⭐ 14,025 | 🐛 996 | 🌐 Python | 📅 2026-09-14 - unified framework for LM benchmark evaluation.
* [BIG-bench](https://github.com/google/BIG-bench) ⚠️ Archived - 200+ tasks probing language model capabilities.
* [MMLU](https://github.com/hendrycks/test) ⭐ 1,616 | 🐛 17 | 🌐 Python | 📅 2023-05-28 - multitask knowledge evaluation across 57 subjects.
...
* [RAGAS](https://github.com/explodinggradients/ragas) ⭐ 15,772 | 🐛 602 | 🌐 Python | 📅 2026-02-24 - reference-free evaluation for RAG and QA pipelines.
...
* [FActScore](https://github.com/shmsw25/FActScore) ⭐ 458 | 🐛 22 | 🌐 Python | 📅 2025-04-13 - fine-grained factual precision in long-form generation.
...
* [GTE](https://huggingface.co/thenlper/gte-base), [BGE](https://github.com/FlagOpen/FlagEmbedding) ⭐ 12,176 | 🐛 910 | 🌐 Python | 📅 2026-08-24, and [Stella](https://huggingface.co/dunzhang/stella_en_1.5B_v5) - compact text embedding models near the top of MTEB.
* [SetFit](https://github.com/huggingface/setfit) ⭐ 2,809 | 🐛 154 | 🌐 Jupyter Notebook | 📅 2026-09-18 - few-shot text classification without prompts.
...
* [GGUF / llama.cpp](https://github.com/ggerganov/llama.cpp) ⭐ 128,797 | 🐛 2,495 | 🌐 C++ | 📅 2026-09-19 - portable quantized inference.
* [vLLM](https://github.com/vllm-project/vllm) ⭐ 92,160 | 🐛 8,129 | 🌐 Python | 📅 2026-09-19 - PagedAttention-based high-throughput LM serving.
* [SGLang](https://github.com/sgl-project/sglang) ⭐ 36,162 | 🐛 5,401 | 🌐 Python | 📅 2026-09-19 - structured generation and efficient serving.
...
* [PEFT](https://github.com/huggingface/peft) ⭐ 21,701 | 🐛 81 | 🌐 Python | 📅 2026-09-18 - HuggingFace library bundling LoRA, prefix tuning, IA3, and others.
...
* [TRL](https://github.com/huggingface/trl) ⭐ 19,342 | 🐛 287 | 🌐 Python | 📅 2026-09-19 - reference library for SFT, DPO, GRPO, and RLHF.
* [Self-Instruct](https://github.com/yizhongw/self-instruct) ⭐ 4,610 | 🐛 13 | 🌐 Python | 📅 2023-03-27 - bootstrapping instruction data from LMs.
* [Super-NaturalInstructions](https://github.com/allenai/natural-instructions) ⭐ 1,048 | 🐛 78 | 🌐 Python | 📅 2023-12-11 - 1600+ NLP tasks with instructions.
...
* [HanLP](https://github.com/hankcs/HanLP) ⭐ 36,489 | 🐛 12 | 🌐 Python | 📅 2026-09-15 - multilingual NLP library with strong Chinese support.
* [jieba](https://github.com/fxsjy/jieba#jieba-1) ⭐ 35,158 | 🐛 700 | 🌐 Python | 📅 2024-08-21 - Python package for Chinese word segmentation.
* [SnowNLP](https://github.com/isnowfy/snownlp) ⭐ 6,632 | 🐛 44 | 🌐 Python | 📅 2020-01-19 - Python package for Chinese NLP.
* [LTP](https://github.com/HIT-SCIR/ltp) ⭐ 5,261 | 🐛 76 | 🌐 Python | 📅 2026-03-11 - HIT Language Technology Platform: segmentation, POS, NER, parsing.
* [FudanNLP](https://github.com/FudanNLP/fnlp) ⭐ 2,683 | 🐛 43 | 🌐 Java | 📅 2023-11-17 - Java library for Chinese text processing.

### Models and Embeddings

* [DeepSeek-V3](https://github.com/deepseek-ai/DeepSeek-V3) ⭐ 104,479 | 🐛 243 | 🌐 Python | 📅 2025-08-28 - efficient open MoE model with strong Chinese.
* [Qwen 2.5 / Qwen 3](https://github.com/QwenLM/Qwen3) ⭐ 27,641 | 🐛 68 | 🌐 Python | 📅 2026-01-09 - Alibaba's open Chinese-strong LM family.
* [ChatGLM3 / GLM-4](https://github.com/THUDM/ChatGLM3) ⭐ 13,648 | 🐛 35 | 🌐 Python | 📅 2025-01-13 - Tsinghua's bilingual Chinese-English LMs.
* [Chinese-BERT-wwm](https://github.com/ymcui/Chinese-BERT-wwm) ⭐ 10,228 | 🐛 1 | 🌐 Python | 📅 2026-04-19 - whole-word masking BERT for Chinese.
...
* [funNLP](https://github.com/fighting41love/funNLP) ⭐ 83,242 | 🐛 53 | 🌐 Python | 📅 2024-05-10 - large collection of Chinese NLP tools and resources.
...
* [IndicTrans2](https://github.com/AI4Bharat/IndicTrans2) ⭐ 474 | 🐛 17 | 🌐 Python | 📅 2025-10-03 (2023-2024) - high-quality MT for 22 Indic languages.
...
* [SEA-LION](https://github.com/aisingapore/sealion) ⭐ 425 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2026-09-18 (2024) - Singapore AI's open Southeast-Asian LM with strong Indonesian.
...
* [Kiwi](https://github.com/bab2min/Kiwi) ⭐ 782 | 🐛 15 | 🌐 C++ | 📅 2026-09-15 - fast Korean morphological analyzer.
* [kss](https://github.com/hyunwoongko/kss) ⭐ 469 | 🐛 6 | 🌐 Python | 📅 2025-11-13 - Korean sentence splitter.
* [Garu](https://github.com/ongjin/garu) ⭐ 176 | 🐛 0 | 🌐 Python | 📅 2026-09-14 - browser-native Korean morphological analyzer running fully client-side via WebAssembly (1MB model, offline, MIT).
...
* [Hazm](https://github.com/roshan-research/hazm) ⭐ 1,424 | 🐛 8 | 🌐 Python | 📅 2026-04-01 - Persian NLP toolkit.
...
* [BERTimbau](https://github.com/neuralmind-ai/portuguese-bert) ⭐ 885 | 🐛 20 | 🌐 Python | 📅 2024-06-17 - BERT for Brazilian Portuguese.
...
* [PyThaiNLP](https://github.com/PyThaiNLP/pythainlp) ⭐ 1,154 | 🐛 32 | 🌐 Python | 📅 2026-09-19 - Thai NLP in Python.
...
* [VieNeu-TTS](https://github.com/pnnbao97/VieNeu-TTS) ⭐ 2,631 | 🐛 13 | 🌐 Python | 📅 2026-09-18 - on-device Vietnamese text-to-speech with voice cloning.
* [underthesea](https://github.com/undertheseanlp/underthesea) ⭐ 1,808 | 🐛 37 | 🌐 Python | 📅 2026-09-19 - Vietnamese NLP toolkit.
...
* [awesome-llm](https://github.com/Hannibal046/Awesome-LLM) ⭐ 27,405 | 🐛 459 | 📅 2025-07-31 - general-purpose large language model resources.
* [awesome-mlops](https://github.com/visenger/awesome-mlops) ⭐ 14,216 | 🐛 46 | 📅 2024-11-21 - production ML, including LLM serving.
* [awesome-generative-ai](https://github.com/steven2358/awesome-generative-ai) ⭐ 12,654 | 🐛 688 | 📅 2026-09-16 - generative AI across modalities.
* [awesome-prompt-engineering](https://github.com/promptslab/Awesome-Prompt-Engineering) ⭐ 6,334 | 🐛 116 | 🌐 TypeScript | 📅 2026-09-19 - prompting techniques and template libraries.
* [awesome-rag](https://github.com/Danielskry/Awesome-RAG) ⭐ 1,367 | 🐛 106 | 📅 2026-09-15 - retrieval-augmented generation systems and tooling.
