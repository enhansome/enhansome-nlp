...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 504,699 | 🐛 106 | 📅 2026-09-02
...
*Please read the [contribution guidelines](contributing.md) before contributing. Please add your favourite NLP resource by raising a [pull request](https://github.com/keonkim/awesome-nlp/pulls) ⭐ 18,975 | 🐛 17 | 📅 2026-09-07*
...
* [Deep NLP Course](https://github.com/yandexdataschool/nlp_course) ⭐ 10,679 | 🐛 8 | 🌐 Jupyter Notebook | 📅 2026-08-24 by Yandex Data School, covering important ideas from text embedding to machine translation including sequence modeling, language models and so on.
...
* <a id="node-js">**Node.js and Javascript** - Node.js Libaries for NLP</a> | [Back to Top](#contents)
  ...
  * [NLP.js](https://github.com/axa-group/nlp.js) ⭐ 6,589 | 🐛 114 | 🌐 JavaScript | 📅 2025-01-09 - An NLP library for building bots
...
* <a id="python"> **Python** - Python NLP Libraries</a> | [Back to Top](#contents)
  * [Transformers](https://github.com/huggingface/transformers) ⭐ 165,072 | 🐛 2,410 | 🌐 Python | 📅 2026-09-10 - Natural Language Processing for TensorFlow 2.0 and PyTorch.
  * [spaCy](https://github.com/explosion/spaCy) ⭐ 33,888 | 🐛 239 | 🌐 Python | 📅 2026-08-24 - Industrial strength NLP with Python and Cython :+1:
  ...
  * [Haystack](https://github.com/deepset-ai/haystack) ⭐ 26,466 | 🐛 131 | 🌐 Python | 📅 2026-09-10 - End-to-end Python framework for building natural language search interfaces to data. Leverages Transformers and the State-of-the-Art of NLP. Supports DPR, Elasticsearch, HuggingFace’s Modelhub, and much more!
  * [HuggingFace Datasets](https://github.com/huggingface/datasets) ⭐ 21,958 | 🐛 1,364 | 🌐 Python | 📅 2026-09-10 - standardized loaders and processing for thousands of NLP datasets.
  * [Sentence-Transformers](https://github.com/UKPLab/sentence-transformers) ⭐ 19,086 | 🐛 1,296 | 🌐 Python | 📅 2026-09-10 - sentence/document embeddings, semantic search, and re-ranking; current standard for retrieval-style NLP.
  ...
  * [Tokenizers](https://github.com/huggingface/tokenizers) ⭐ 11,026 | 🐛 257 | 🌐 Rust | 📅 2026-09-10 - Tokenizers optimized for Research and Production.
  ...
  * [Stanza](https://github.com/stanfordnlp/stanza) ⭐ 7,874 | 🐛 94 | 🌐 Python | 📅 2026-09-08 - Stanford NLP's Python toolkit for tokenization, POS, lemma, dependency parsing, and NER across 70+ languages.
  * [Argilla](https://github.com/argilla-io/argilla) ⭐ 5,105 | 🐛 33 | 🌐 Python | 📅 2026-09-07 - open-source data annotation and feedback collection platform for LLM and NLP datasets.
  ...
  * [COMET](https://github.com/Unbabel/COMET) ⭐ 779 | 🐛 62 | 🌐 Python | 📅 2026-04-21 - learned MT metrics, current de-facto standard.
  ...
  * [yasbd-lib](https://github.com/speedyk-005/yasbd-lib) ⭐ 28 | 🐛 13 | 🌐 Python | 📅 2026-09-09 - High-accuracy, rule-based sentence boundary detector (SBD). Drop-in pysbd adapter, streaming APIs, CLI, and a spaCy component across 39+ languages.
...
- <a id="kotlin">**Kotlin** - Kotlin NLP Libraries</a> | [Back to Top](#contents)
  * [Lingua](https://github.com/pemistahl/lingua/) ⭐ 822 | 🐛 13 | 🌐 Kotlin | 📅 2025-03-21 A language detection library for Kotlin and Java, suitable for long and short text alike
...
- <a id="scala">**Scala** - Scala NLP Libraries</a> | [Back to Top](#contents)
  * [Spark NLP](https://github.com/JohnSnowLabs/spark-nlp) ⭐ 4,158 | 🐛 38 | 🌐 Scala | 📅 2026-09-09 - Spark NLP is a natural language processing library built on top of Apache Spark ML that provides simple, performant & accurate NLP annotations for machine learning pipelines that scale easily in a distributed environment.
...
- <a id="NLP++">**NLP++** - NLP++ Language</a> | [Back to Top](#contents)
  * [nlp-engine](https://github.com/VisualText/nlp-engine) ⭐ 24 | 🐛 83 | 🌐 C++ | 📅 2026-09-10 - NLP++ engine to run NLP++ code on Linux including a full English parser
...
* [Label Studio](https://github.com/HumanSignal/label-studio) ⭐ 28,240 | 🐛 941 | 🌐 TypeScript | 📅 2026-09-10 - open-core multi-modal labeling platform; widely used for NLP labeling.
...
* [Argilla](https://github.com/argilla-io/argilla) ⭐ 5,105 | 🐛 33 | 🌐 Python | 📅 2026-09-07 - open-source platform for collecting human feedback, building NLP and LLM datasets, and curating preference data.
* [Potato](https://github.com/davidjurgens/potato) ⭐ 420 | 🐛 6 | 🌐 Python | 📅 2026-09-10 - Free, open-source annotation tool covering 21+ task types (classification, span, coreference, entity linking, agent trace evaluation) with built-in MACE quality control, attention checks, AI-assisted labeling, and 300+ example tasks.
...
Modern sentence and document embeddings: see [Retrieval for NLP](#retrieval-for-nlp) (Sentence-Transformers, E5, BGE-M3, Nomic, GritLM) and [MTEB](https://github.com/embeddings-benchmark/mteb) ⭐ 3,418 | 🐛 331 | 🌐 Python | 📅 2026-09-10 for current leaderboards.

### Tokenization, Morphology, and Segmentation

[Back to Top](#contents)

* [SentencePiece](https://github.com/google/sentencepiece) ⭐ 12,070 | 🐛 6 | 🌐 C++ | 📅 2026-09-10 - language-agnostic subword tokenization.

* [SentencePiece](https://github.com/google/sentencepiece) ⭐ 12,070 | 🐛 6 | 🌐 C++ | 📅 2026-09-10 - language-agnostic subword tokenization (BPE and Unigram).

* [Tokenizers](https://github.com/huggingface/tokenizers) ⭐ 11,026 | 🐛 257 | 🌐 Rust | 📅 2026-09-10 - fast Rust implementations of BPE, WordPiece, Unigram.

* [Stanza](https://github.com/stanfordnlp/stanza) ⭐ 7,874 | 🐛 94 | 🌐 Python | 📅 2026-09-08 - tokenization, lemma, and morphology for 70+ languages.

* [UDPipe](https://github.com/ufal/udpipe) ⭐ 419 | 🐛 16 | 🌐 C++ | 📅 2026-06-11 - tokenization, tagging, lemmatization, parsing for Universal Dependencies.
...
* [spaCy](https://spacy.io/) and [Stanza](https://github.com/stanfordnlp/stanza) ⭐ 7,874 | 🐛 94 | 🌐 Python | 📅 2026-09-08 - production parsers across many languages.
...
* [SetFit](https://github.com/huggingface/setfit) ⭐ 2,799 | 🐛 154 | 🌐 Jupyter Notebook | 📅 2026-09-08 - few-shot text classification without prompts.
...
* [BERTopic](https://github.com/MaartenGr/BERTopic) ⭐ 7,831 | 🐛 471 | 🌐 Python | 📅 2026-09-09 - clustering-based topic modeling on top of contextual embeddings; common modern default.
...
* [Marian NMT](https://github.com/marian-nmt/marian) ⭐ 1,470 | 🐛 97 | 🌐 C++ | 📅 2023-08-25 - efficient C++ NMT framework.
...
* [COMET](https://github.com/Unbabel/COMET) ⭐ 779 | 🐛 62 | 🌐 Python | 📅 2026-04-21 - learned MT metric; current de-facto standard alongside chrF.
...
* [Whisper](https://github.com/openai/whisper) ⭐ 108,832 | 🐛 148 | 🌐 Python | 📅 2026-08-31 - multilingual ASR; the modern open default.
* [Coqui TTS](https://github.com/coqui-ai/TTS) ⭐ 45,997 | 🐛 2 | 🌐 Python | 📅 2024-08-16 and [VieNeu-TTS](https://github.com/pnnbao97/VieNeu-TTS) ⭐ 2,528 | 🐛 10 | 🌐 Python | 📅 2026-09-09 - open TTS.
* [FunASR](https://github.com/modelscope/FunASR) ⭐ 20,260 | 🐛 22 | 🌐 Python | 📅 2026-09-10 - industrial-grade ASR toolkit; 170× realtime on GPU, 50+ languages, built-in VAD, punctuation, speaker diarization, and emotion detection. Includes non-autoregressive SenseVoice and LLM-based Fun-ASR-Nano models.
...
* [Dolma](https://github.com/allenai/dolma) ⭐ 1,542 | 🐛 26 | 🌐 Python | 📅 2026-08-24 (AI2, 2023-2024) - 3T-token open pretraining corpus with documented filtering pipeline.
...
* [UDPipe](https://github.com/ufal/udpipe) ⭐ 419 | 🐛 16 | 🌐 C++ | 📅 2026-06-11 is a trainable pipeline for tokenizing, tagging, lemmatizing and parsing Universal Treebanks and other CoNLL-U files. Primarily written in C++, offers a fast and reliable solution for multilingual NLP processing.
...
* [MTEB](https://github.com/embeddings-benchmark/mteb) ⭐ 3,418 | 🐛 331 | 🌐 Python | 📅 2026-09-10 - Massive Text Embedding Benchmark; standard for sentence/document encoders.
* [BEIR](https://github.com/beir-cellar/beir) ⭐ 2,286 | 🐛 83 | 🌐 Python | 📅 2025-10-16 - heterogeneous IR benchmark for retrieval models.
...
* [LM Evaluation Harness](https://github.com/EleutherAI/lm-evaluation-harness) ⭐ 13,944 | 🐛 959 | 🌐 Python | 📅 2026-09-01 - unified framework for LM benchmark evaluation.
...
* [Needle in a Haystack](https://github.com/gkamradt/LLMTest_NeedleInAHaystack) ⭐ 2,381 | 🐛 29 | 🌐 Jupyter Notebook | 📅 2026-06-08 - retrieval probe for long-context windows.
* [LongBench](https://github.com/THUDM/LongBench) ⭐ 1,234 | 🐛 68 | 🌐 Python | 📅 2025-01-15 - bilingual long-context benchmark across NLP tasks.
...
* [RAGAS](https://github.com/explodinggradients/ragas) ⭐ 15,696 | 🐛 595 | 🌐 Python | 📅 2026-02-24 - reference-free evaluation for RAG and QA pipelines.
* [TruthfulQA](https://github.com/sylinrl/TruthfulQA) ⭐ 944 | 🐛 21 | 🌐 Jupyter Notebook | 📅 2025-01-16 - benchmark for truthfulness in question answering.
...
* [GGUF / llama.cpp](https://github.com/ggerganov/llama.cpp) ⭐ 127,713 | 🐛 2,460 | 🌐 C++ | 📅 2026-09-10 - portable quantized inference.
* [vLLM](https://github.com/vllm-project/vllm) ⭐ 91,417 | 🐛 7,831 | 🌐 Python | 📅 2026-09-10 - PagedAttention-based high-throughput LM serving.
* [SGLang](https://github.com/sgl-project/sglang) ⭐ 35,749 | 🐛 5,261 | 🌐 Python | 📅 2026-09-10 - structured generation and efficient serving.
...
* [PEFT](https://github.com/huggingface/peft) ⭐ 21,648 | 🐛 70 | 🌐 Python | 📅 2026-09-10 - HuggingFace library bundling LoRA, prefix tuning, IA3, and others.
...
* [TRL](https://github.com/huggingface/trl) ⭐ 19,267 | 🐛 301 | 🌐 Python | 📅 2026-09-10 - reference library for SFT, DPO, GRPO, and RLHF.
...
* [HanLP](https://github.com/hankcs/HanLP) ⭐ 36,490 | 🐛 12 | 🌐 Python | 📅 2025-11-15 - multilingual NLP library with strong Chinese support.
* [jieba](https://github.com/fxsjy/jieba#jieba-1) ⭐ 35,146 | 🐛 700 | 🌐 Python | 📅 2024-08-21 - Python package for Chinese word segmentation.
...
* [DeepSeek-V3](https://github.com/deepseek-ai/DeepSeek-V3) ⭐ 104,429 | 🐛 222 | 🌐 Python | 📅 2025-08-28 - efficient open MoE model with strong Chinese.
* [Qwen 2.5 / Qwen 3](https://github.com/QwenLM/Qwen3) ⭐ 27,599 | 🐛 67 | 🌐 Python | 📅 2026-01-09 - Alibaba's open Chinese-strong LM family.
* [ChatGLM3 / GLM-4](https://github.com/THUDM/ChatGLM3) ⭐ 13,656 | 🐛 35 | 🌐 Python | 📅 2025-01-13 - Tsinghua's bilingual Chinese-English LMs.
...
* [funNLP](https://github.com/fighting41love/funNLP) ⭐ 83,009 | 🐛 53 | 🌐 Python | 📅 2024-05-10 - large collection of Chinese NLP tools and resources.
...
* [German-NLP](https://github.com/adbar/German-NLP) ⭐ 535 | 🐛 1 | 📅 2024-10-30 - curated list of open-access, open-source, and off-the-shelf resources and tools developed with a focus on German.
...
* [IndicTrans2](https://github.com/AI4Bharat/IndicTrans2) ⭐ 470 | 🐛 16 | 🌐 Python | 📅 2025-10-03 (2023-2024) - high-quality MT for 22 Indic languages.
...
* [Kiwi](https://github.com/bab2min/Kiwi) ⭐ 778 | 🐛 16 | 🌐 C++ | 📅 2026-08-20 - fast Korean morphological analyzer.
...
* [BERTimbau](https://github.com/neuralmind-ai/portuguese-bert) ⭐ 883 | 🐛 20 | 🌐 Python | 📅 2024-06-17 - BERT for Brazilian Portuguese.
...
* [PyThaiNLP](https://github.com/PyThaiNLP/pythainlp) ⭐ 1,152 | 🐛 31 | 🌐 Python | 📅 2026-09-08 - Thai NLP in Python.
...
* [VieNeu-TTS](https://github.com/pnnbao97/VieNeu-TTS) ⭐ 2,528 | 🐛 10 | 🌐 Python | 📅 2026-09-09 - on-device Vietnamese text-to-speech with voice cloning.
* [underthesea](https://github.com/undertheseanlp/underthesea) ⭐ 1,802 | 🐛 34 | 🌐 Python | 📅 2026-09-10 - Vietnamese NLP toolkit.
...
* [awesome-llm](https://github.com/Hannibal046/Awesome-LLM) ⭐ 27,351 | 🐛 451 | 📅 2025-07-31 - general-purpose large language model resources.
* [awesome-mlops](https://github.com/visenger/awesome-mlops) ⭐ 14,191 | 🐛 44 | 📅 2024-11-21 - production ML, including LLM serving.
* [awesome-generative-ai](https://github.com/steven2358/awesome-generative-ai) ⭐ 12,599 | 🐛 649 | 📅 2026-09-09 - generative AI across modalities.
* [awesome-prompt-engineering](https://github.com/promptslab/Awesome-Prompt-Engineering) ⭐ 6,325 | 🐛 113 | 🌐 TypeScript | 📅 2026-09-10 - prompting techniques and template libraries.
* [awesome-rag](https://github.com/Danielskry/Awesome-RAG) ⭐ 1,359 | 🐛 98 | 📅 2026-07-09 - retrieval-augmented generation systems and tooling.
