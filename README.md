...
*Please read the [contribution guidelines](contributing.md) before contributing. Please add your favourite NLP resource by raising a [pull request](https://github.com/keonkim/awesome-nlp/pulls) ⭐ 18,972 | 🐛 17 | 📅 2026-09-07*
...
* [Deep NLP Course](https://github.com/yandexdataschool/nlp_course) ⭐ 10,677 | 🐛 8 | 🌐 Jupyter Notebook | 📅 2026-08-24 by Yandex Data School, covering important ideas from text embedding to machine translation including sequence modeling, language models and so on.
...
* <a id="node-js">**Node.js and Javascript** - Node.js Libaries for NLP</a> | [Back to Top](#contents)
  * [NLP Compromise](https://github.com/spencermountain/compromise) ⭐ 12,152 | 🐛 122 | 🌐 JavaScript | 📅 2026-09-09 - Natural Language processing in the browser
...
* <a id="python"> **Python** - Python NLP Libraries</a> | [Back to Top](#contents)
  * [Transformers](https://github.com/huggingface/transformers) ⭐ 165,032 | 🐛 2,404 | 🌐 Python | 📅 2026-09-09 - Natural Language Processing for TensorFlow 2.0 and PyTorch.
  ...
  * [Haystack](https://github.com/deepset-ai/haystack) ⭐ 26,455 | 🐛 123 | 🌐 Python | 📅 2026-09-09 - End-to-end Python framework for building natural language search interfaces to data. Leverages Transformers and the State-of-the-Art of NLP. Supports DPR, Elasticsearch, HuggingFace’s Modelhub, and much more!
  * [HuggingFace Datasets](https://github.com/huggingface/datasets) ⭐ 21,958 | 🐛 1,366 | 🌐 Python | 📅 2026-09-07 - standardized loaders and processing for thousands of NLP datasets.
  * [Sentence-Transformers](https://github.com/UKPLab/sentence-transformers) ⭐ 19,081 | 🐛 1,297 | 🌐 Python | 📅 2026-09-08 - sentence/document embeddings, semantic search, and re-ranking; current standard for retrieval-style NLP.
  * [Flair](https://github.com/zalandoresearch/flair) ⭐ 14,385 | 🐛 31 | 🌐 Python | 📅 2025-10-27 - A very simple framework for state-of-the-art multilingual NLP built on PyTorch. Includes BERT, ELMo and Flair embeddings.
  ...
  * [Tokenizers](https://github.com/huggingface/tokenizers) ⭐ 11,025 | 🐛 258 | 🌐 Rust | 📅 2026-09-04 - Tokenizers optimized for Research and Production.
  ...
  * [HuggingFace Evaluate](https://github.com/huggingface/evaluate) ⭐ 2,479 | 🐛 308 | 🌐 Python | 📅 2026-07-06 - reference implementations for NLP metrics.
  ...
  * [yasbd-lib](https://github.com/speedyk-005/yasbd-lib) ⭐ 28 | 🐛 11 | 🌐 Python | 📅 2026-09-08 - High-accuracy, rule-based sentence boundary detector (SBD). Drop-in pysbd adapter, streaming APIs, CLI, and a spaCy component across 39+ languages.
...
- <a id="scala">**Scala** - Scala NLP Libraries</a> | [Back to Top](#contents)
  * [Spark NLP](https://github.com/JohnSnowLabs/spark-nlp) ⭐ 4,158 | 🐛 40 | 🌐 Scala | 📅 2026-09-08 - Spark NLP is a natural language processing library built on top of Apache Spark ML that provides simple, performant & accurate NLP annotations for machine learning pipelines that scale easily in a distributed environment.
...
- <a id="go">**Go**</a> | [Back to Top](#contents)
  * [prose](https://github.com/jdkato/prose) ⭐ 3,089 | 🐛 20 | 🌐 Go | 📅 2026-07-29 - Text processing library supporting tokenization, part-of-speech tagging, and named-entity extraction.
...
* [Wit-ai](https://github.com/wit-ai/wit) ⭐ 964 | 🐛 158 | 📅 2021-09-01 - Natural Language Interface for apps and devices
...
* [Label Studio](https://github.com/HumanSignal/label-studio) ⭐ 28,238 | 🐛 941 | 🌐 TypeScript | 📅 2026-09-09 - open-core multi-modal labeling platform; widely used for NLP labeling.
* [doccano](https://github.com/chakki-works/doccano) ⭐ 10,767 | 🐛 398 | 🌐 Python | 📅 2026-04-14 - doccano is free, open-source, and provides annotation features for text classification, sequence labeling and sequence to sequence
...
* [Potato](https://github.com/davidjurgens/potato) ⭐ 420 | 🐛 6 | 🌐 Python | 📅 2026-09-09 - Free, open-source annotation tool covering 21+ task types (classification, span, coreference, entity linking, agent trace evaluation) with built-in MACE quality control, attention checks, AI-assisted labeling, and 300+ example tasks.
...
* [Shoonya](https://github.com/AI4Bharat/Shoonya-Backend) ⭐ 28 | 🐛 47 | 🌐 Python | 📅 2026-09-04 - Shoonya is free and open source data annotation platform with wide varities of organization and workspace level management system. Shoonya is data agnostic, can be used by teams to annotate data with various level of verification stages at scale.
...
Modern sentence and document embeddings: see [Retrieval for NLP](#retrieval-for-nlp) (Sentence-Transformers, E5, BGE-M3, Nomic, GritLM) and [MTEB](https://github.com/embeddings-benchmark/mteb) ⭐ 3,418 | 🐛 325 | 🌐 Python | 📅 2026-09-09 for current leaderboards.

### Tokenization, Morphology, and Segmentation

[Back to Top](#contents)

* [SentencePiece](https://github.com/google/sentencepiece) ⭐ 12,067 | 🐛 5 | 🌐 C++ | 📅 2026-09-09 - language-agnostic subword tokenization.

* [SentencePiece](https://github.com/google/sentencepiece) ⭐ 12,067 | 🐛 5 | 🌐 C++ | 📅 2026-09-09 - language-agnostic subword tokenization (BPE and Unigram).

* [Tokenizers](https://github.com/huggingface/tokenizers) ⭐ 11,025 | 🐛 258 | 🌐 Rust | 📅 2026-09-04 - fast Rust implementations of BPE, WordPiece, Unigram.

* [Stanza](https://github.com/stanfordnlp/stanza) ⭐ 7,874 | 🐛 94 | 🌐 Python | 📅 2026-09-08 - tokenization, lemma, and morphology for 70+ languages.

* [UDPipe](https://github.com/ufal/udpipe) ⭐ 418 | 🐛 16 | 🌐 C++ | 📅 2026-06-11 - tokenization, tagging, lemmatization, parsing for Universal Dependencies.
...
* [Flair](https://github.com/flairNLP/flair) ⭐ 14,385 | 🐛 31 | 🌐 Python | 📅 2025-10-27 - contextual string embeddings, strong NER across languages.
...
* [BERTopic](https://github.com/MaartenGr/BERTopic) ⭐ 7,828 | 🐛 471 | 🌐 Python | 📅 2026-09-09 - clustering-based topic modeling on top of contextual embeddings; common modern default.
...
* [BGE](https://github.com/FlagOpen/FlagEmbedding) ⭐ 12,151 | 🐛 909 | 🌐 Python | 📅 2026-08-24 and [BGE-M3](https://arxiv.org/abs/2402.03216) (2024) - multilingual, multi-functionality embeddings; top of MTEB across languages.
...
* [Whisper](https://github.com/openai/whisper) ⭐ 108,782 | 🐛 146 | 🌐 Python | 📅 2026-08-31 - multilingual ASR; the modern open default.
* [Coqui TTS](https://github.com/coqui-ai/TTS) ⭐ 45,994 | 🐛 2 | 🌐 Python | 📅 2024-08-16 and [VieNeu-TTS](https://github.com/pnnbao97/VieNeu-TTS) ⭐ 2,516 | 🐛 10 | 🌐 Python | 📅 2026-09-09 - open TTS.
* [FunASR](https://github.com/modelscope/FunASR) ⭐ 20,240 | 🐛 21 | 🌐 Python | 📅 2026-09-09 - industrial-grade ASR toolkit; 170× realtime on GPU, 50+ languages, built-in VAD, punctuation, speaker diarization, and emotion detection. Includes non-autoregressive SenseVoice and LLM-based Fun-ASR-Nano models.
...
* [UDPipe](https://github.com/ufal/udpipe) ⭐ 418 | 🐛 16 | 🌐 C++ | 📅 2026-06-11 is a trainable pipeline for tokenizing, tagging, lemmatizing and parsing Universal Treebanks and other CoNLL-U files. Primarily written in C++, offers a fast and reliable solution for multilingual NLP processing.
...
* [MTEB](https://github.com/embeddings-benchmark/mteb) ⭐ 3,418 | 🐛 325 | 🌐 Python | 📅 2026-09-09 - Massive Text Embedding Benchmark; standard for sentence/document encoders.
* [BEIR](https://github.com/beir-cellar/beir) ⭐ 2,285 | 🐛 83 | 🌐 Python | 📅 2025-10-16 - heterogeneous IR benchmark for retrieval models.
...
* [LM Evaluation Harness](https://github.com/EleutherAI/lm-evaluation-harness) ⭐ 13,937 | 🐛 955 | 🌐 Python | 📅 2026-09-01 - unified framework for LM benchmark evaluation.
...
* [RAGAS](https://github.com/explodinggradients/ragas) ⭐ 15,689 | 🐛 598 | 🌐 Python | 📅 2026-02-24 - reference-free evaluation for RAG and QA pipelines.
...
* [GTE](https://huggingface.co/thenlper/gte-base), [BGE](https://github.com/FlagOpen/FlagEmbedding) ⭐ 12,151 | 🐛 909 | 🌐 Python | 📅 2026-08-24, and [Stella](https://huggingface.co/dunzhang/stella_en_1.5B_v5) - compact text embedding models near the top of MTEB.
* [SetFit](https://github.com/huggingface/setfit) ⭐ 2,799 | 🐛 154 | 🌐 Jupyter Notebook | 📅 2026-09-08 - few-shot text classification without prompts.
...
* [GGUF / llama.cpp](https://github.com/ggerganov/llama.cpp) ⭐ 127,605 | 🐛 2,449 | 🌐 C++ | 📅 2026-09-09 - portable quantized inference.
* [vLLM](https://github.com/vllm-project/vllm) ⭐ 91,339 | 🐛 7,786 | 🌐 Python | 📅 2026-09-09 - PagedAttention-based high-throughput LM serving.
* [SGLang](https://github.com/sgl-project/sglang) ⭐ 35,692 | 🐛 5,183 | 🌐 Python | 📅 2026-09-09 - structured generation and efficient serving.
...
* [PEFT](https://github.com/huggingface/peft) ⭐ 21,646 | 🐛 81 | 🌐 Python | 📅 2026-09-08 - HuggingFace library bundling LoRA, prefix tuning, IA3, and others.
...
* [TRL](https://github.com/huggingface/trl) ⭐ 19,254 | 🐛 304 | 🌐 Python | 📅 2026-09-09 - reference library for SFT, DPO, GRPO, and RLHF.
...
* [DeepSeek-V3](https://github.com/deepseek-ai/DeepSeek-V3) ⭐ 104,424 | 🐛 221 | 🌐 Python | 📅 2025-08-28 - efficient open MoE model with strong Chinese.
* [Qwen 2.5 / Qwen 3](https://github.com/QwenLM/Qwen3) ⭐ 27,599 | 🐛 67 | 🌐 Python | 📅 2026-01-09 - Alibaba's open Chinese-strong LM family.
* [ChatGLM3 / GLM-4](https://github.com/THUDM/ChatGLM3) ⭐ 13,657 | 🐛 35 | 🌐 Python | 📅 2025-01-13 - Tsinghua's bilingual Chinese-English LMs.
...
* [funNLP](https://github.com/fighting41love/funNLP) ⭐ 82,985 | 🐛 53 | 🌐 Python | 📅 2024-05-10 - large collection of Chinese NLP tools and resources.
...
* [Garu](https://github.com/ongjin/garu) ⭐ 175 | 🐛 0 | 🌐 Python | 📅 2026-09-07 - browser-native Korean morphological analyzer running fully client-side via WebAssembly (1MB model, offline, MIT).
...
* [KLUE-RoBERTa](https://github.com/KLUE-benchmark/KLUE) ⭐ 605 | 🐛 19 | 📅 2026-06-30 - models trained on the KLUE benchmark.
...
* [Hazm](https://github.com/roshan-research/hazm) ⭐ 1,420 | 🐛 9 | 🌐 Python | 📅 2026-04-01 - Persian NLP toolkit.
...
* [Portuguese-nlp](https://github.com/ajdavidl/Portuguese-NLP) ⭐ 371 | 🐛 1 | 📅 2026-06-25 - curated list of Portuguese NLP resources and tools.

### Models

* [BERTimbau](https://github.com/neuralmind-ai/portuguese-bert) ⭐ 881 | 🐛 20 | 🌐 Python | 📅 2024-06-17 - BERT for Brazilian Portuguese.
...
* [VieNeu-TTS](https://github.com/pnnbao97/VieNeu-TTS) ⭐ 2,516 | 🐛 10 | 🌐 Python | 📅 2026-09-09 - on-device Vietnamese text-to-speech with voice cloning.
* [underthesea](https://github.com/undertheseanlp/underthesea) ⭐ 1,802 | 🐛 32 | 🌐 Python | 📅 2026-09-08 - Vietnamese NLP toolkit.
...
* [awesome-llm](https://github.com/Hannibal046/Awesome-LLM) ⭐ 27,348 | 🐛 450 | 📅 2025-07-31 - general-purpose large language model resources.
* [awesome-mlops](https://github.com/visenger/awesome-mlops) ⭐ 14,189 | 🐛 44 | 📅 2024-11-21 - production ML, including LLM serving.
* [awesome-generative-ai](https://github.com/steven2358/awesome-generative-ai) ⭐ 12,586 | 🐛 637 | 📅 2026-09-09 - generative AI across modalities.
* [awesome-prompt-engineering](https://github.com/promptslab/Awesome-Prompt-Engineering) ⭐ 6,321 | 🐛 112 | 🌐 TypeScript | 📅 2026-09-09 - prompting techniques and template libraries.
* [awesome-rag](https://github.com/Danielskry/Awesome-RAG) ⭐ 1,357 | 🐛 97 | 📅 2026-07-09 - retrieval-augmented generation systems and tooling.
