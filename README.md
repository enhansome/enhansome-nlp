...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 509,242 | 🐛 106 | 📅 2026-09-02
...
*Please read the [contribution guidelines](contributing.md) before contributing. Please add your favourite NLP resource by raising a [pull request](https://github.com/keonkim/awesome-nlp/pulls) ⭐ 19,028 | 🐛 19 | 📅 2026-09-07*
...
* [NLP in Python](http://github.com/NirantK/nlp-python-deep-learning) ⭐ 606 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2024-01-31 - Collection of Github notebooks
* [Hands-On NLTK Tutorial](https://github.com/hb20007/hands-on-nltk-tutorial) ⭐ 570 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-04-17 - NLTK Tutorials, Jupyter notebooks
...
* [Deep Natural Language Processing](https://github.com/oxford-cs-deepnlp-2017/lectures) ⭐ 15,856 | 🐛 12 | 📅 2023-07-02 - Lectures series from Oxford
* [Deep NLP Course](https://github.com/yandexdataschool/nlp_course) ⭐ 10,699 | 🐛 8 | 🌐 Jupyter Notebook | 📅 2026-09-18 by Yandex Data School, covering important ideas from text embedding to machine translation including sequence modeling, language models and so on.
* [fast.ai Code-First Intro to Natural Language Processing](https://www.fast.ai/2019/07/08/fastai-nlp/) - This covers a blend of traditional NLP topics (including regex, SVD, naive bayes, tokenization) and recent neural network approaches (including RNNs, seq2seq, GRUs, and the Transformer), as well as addressing urgent ethical issues, such as bias and disinformation. Find the Jupyter Notebooks [here](https://github.com/fastai/course-nlp) ⭐ 3,489 | 🐛 54 | 🌐 Jupyter Notebook | 📅 2023-03-22
* [Machine Learning University - Accelerated Natural Language Processing](https://www.youtube.com/playlist?list=PL8P_Z6C4GcuWfAq8Pt6PBYlck4OprHXsw) - Lectures go from introduction to NLP and text processing to Recurrent Neural Networks and Transformers.
  Material can be found [here](https://github.com/aws-samples/aws-machine-learning-university-accelerated-nlp) ⭐ 2,434 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2024-10-13.
...
* [NLP with PyTorch](https://github.com/joosthub/PyTorchNLPBook) ⭐ 2,059 | 🐛 26 | 🌐 Jupyter Notebook | 📅 2023-03-12 - Brian & Delip Rao
...
* <a id="node-js">**Node.js and Javascript** - Node.js Libaries for NLP</a> | [Back to Top](#contents)
  * [NLP Compromise](https://github.com/spencermountain/compromise) ⭐ 12,159 | 🐛 119 | 🌐 JavaScript | 📅 2026-09-23 - Natural Language processing in the browser
  ...
  * [NLP.js](https://github.com/axa-group/nlp.js) ⭐ 6,585 | 🐛 114 | 🌐 JavaScript | 📅 2025-01-09 - An NLP library for building bots
  * [Knwl.js](https://github.com/benhmoore/Knwl.js) ⭐ 5,250 | 🐛 13 | 🌐 JavaScript | 📅 2023-09-28 - A Natural Language Processor in JS
  ...
  * [Poplar](https://github.com/synyi/poplar) ⭐ 529 | 🐛 67 | 🌐 TypeScript | 📅 2022-12-11 - A web-based annotation tool for natural language processing (NLP)
...
* <a id="python"> **Python** - Python NLP Libraries</a> | [Back to Top](#contents)
  * [Transformers](https://github.com/huggingface/transformers) ⭐ 166,564 | 🐛 2,400 | 🌐 Python | 📅 2026-09-23 - Natural Language Processing for TensorFlow 2.0 and PyTorch.
  * [spaCy](https://github.com/explosion/spaCy) ⭐ 33,916 | 🐛 245 | 🌐 Python | 📅 2026-08-24 - Industrial strength NLP with Python and Cython :+1:
  ...
  * [Haystack](https://github.com/deepset-ai/haystack) ⭐ 26,584 | 🐛 153 | 🌐 Python | 📅 2026-09-23 - End-to-end Python framework for building natural language search interfaces to data. Leverages Transformers and the State-of-the-Art of NLP. Supports DPR, Elasticsearch, HuggingFace’s Modelhub, and much more!
  * [HuggingFace Datasets](https://github.com/huggingface/datasets) ⭐ 22,005 | 🐛 1,411 | 🌐 Python | 📅 2026-09-23 - standardized loaders and processing for thousands of NLP datasets.
  * [Sentence-Transformers](https://github.com/UKPLab/sentence-transformers) ⭐ 19,112 | 🐛 1,321 | 🌐 Python | 📅 2026-09-21 - sentence/document embeddings, semantic search, and re-ranking; current standard for retrieval-style NLP.
  * [Flair](https://github.com/zalandoresearch/flair) ⭐ 14,389 | 🐛 31 | 🌐 Python | 📅 2025-10-27 - A very simple framework for state-of-the-art multilingual NLP built on PyTorch. Includes BERT, ELMo and Flair embeddings.
  ...
  * [Tokenizers](https://github.com/huggingface/tokenizers) ⭐ 11,102 | 🐛 208 | 🌐 Rust | 📅 2026-09-23 - Tokenizers optimized for Research and Production.
  ...
  * [Stanza](https://github.com/stanfordnlp/stanza) ⭐ 7,882 | 🐛 95 | 🌐 Python | 📅 2026-09-23 - Stanford NLP's Python toolkit for tokenization, POS, lemma, dependency parsing, and NER across 70+ languages.
  * [Argilla](https://github.com/argilla-io/argilla) ⭐ 5,122 | 🐛 34 | 🌐 Python | 📅 2026-09-21 - open-source data annotation and feedback collection platform for LLM and NLP datasets.
  * [Snips NLU](https://github.com/snipsco/snips-nlu) ⭐ 3,971 | 🐛 67 | 🌐 Python | 📅 2023-05-22 - A production ready library for intent parsing
  * [TextAttack](https://github.com/QData/TextAttack) ⭐ 3,471 | 🐛 21 | 🌐 Python | 📅 2026-08-15 - Adversarial attacks, adversarial training, and data augmentation in NLP
  ...
  * [HuggingFace Evaluate](https://github.com/huggingface/evaluate) ⭐ 2,483 | 🐛 312 | 🌐 Python | 📅 2026-09-23 - reference implementations for NLP metrics.
  ...
  * [scattertext](https://github.com/JasonKessler/scattertext) ⭐ 2,343 | 🐛 23 | 🌐 Python | 📅 2026-07-04 - Python library to produce d3 visualizations of how language differs between corpora
  ...
  * [sacrebleu](https://github.com/mjpost/sacrebleu) ⭐ 1,259 | 🐛 23 | 🌐 Python | 📅 2026-08-20 - reproducible BLEU/chrF/TER scoring for machine translation.
  ...
  * [COMET](https://github.com/Unbabel/COMET) ⭐ 779 | 🐛 64 | 🌐 Python | 📅 2026-04-21 - learned MT metrics, current de-facto standard.
  * [BigARTM](https://github.com/bigartm/bigartm) ⭐ 674 | 🐛 136 | 🌐 C++ | 📅 2026-02-05 - a fast library for topic modelling
  * [corex\_topic](https://github.com/gregversteeg/corex_topic) ⭐ 646 | 🐛 13 | 🌐 Python | 📅 2021-03-22 - Hierarchical Topic Modeling with Minimal Domain Knowledge
  * [Word Forms](https://github.com/gutfeeling/word_forms) ⭐ 627 | 🐛 4 | 🌐 Python | 📅 2021-06-24 - Word forms can accurately generate all possible forms of an English word
  * [LangTest](https://github.com/JohnSnowLabs/langtest) ⭐ 560 | 🐛 6 | 🌐 Python | 📅 2026-08-28 - 60+ test types for NLP model robustness, bias, and fairness.
  * [DL Translate](https://github.com/xhlulu/dl-translate) ⭐ 501 | 🐛 3 | 🌐 Python | 📅 2024-09-02 - A deep learning-based translation library for 50 languages, built on `transformers` and Facebook's mBART Large.
  ...
  * [PySS3](https://github.com/sergioburdisso/pyss3) ⭐ 350 | 🐛 6 | 🌐 Python | 📅 2025-10-16 - Python package implementing the SS3 white-box text classifier; ships with interactive visualization tools that explain predictions.
  ...
  * [Pearmut](https://github.com/zouharvi/pearmut) ⭐ 34 | 🐛 8 | 🌐 Python | 📅 2026-08-21 - Human annotation tool for multilingual NLP tasks, such as machine translation.
  ...
  * [yasbd-lib](https://github.com/speedyk-005/yasbd-lib) ⭐ 31 | 🐛 5 | 🌐 Python | 📅 2026-09-23 - High-accuracy, rule-based sentence boundary detector (SBD). Drop-in pysbd adapter, streaming APIs, CLI, and a spaCy component across 39+ languages.
...
- <a id="c++">**C++** - C++ Libraries</a> | [Back to Top](#contents)
  ...
  * [MeTA](https://github.com/meta-toolkit/meta) ⭐ 718 | 🐛 56 | 🌐 C++ | 📅 2023-04-17 - ModErn Text Analysis: a C++ data sciences toolkit for mining big text data.
...
- <a id="java">**Java** - Java NLP Libraries</a> | [Back to Top](#contents)
  ...
  * [OpenRegex](https://github.com/knowitall/openregex) ⭐ 75 | 🐛 1 | 🌐 Java | 📅 2014-03-20 An efficient and flexible token-based regular expression language and engine.
...
- <a id="kotlin">**Kotlin** - Kotlin NLP Libraries</a> | [Back to Top](#contents)
  * [Lingua](https://github.com/pemistahl/lingua/) ⭐ 824 | 🐛 13 | 🌐 Kotlin | 📅 2025-03-21 A language detection library for Kotlin and Java, suitable for long and short text alike
...
- <a id="scala">**Scala** - Scala NLP Libraries</a> | [Back to Top](#contents)
  * [Spark NLP](https://github.com/JohnSnowLabs/spark-nlp) ⭐ 4,159 | 🐛 35 | 🌐 Scala | 📅 2026-09-21 - Spark NLP is a natural language processing library built on top of Apache Spark ML that provides simple, performant & accurate NLP annotations for machine learning pipelines that scale easily in a distributed environment.
...
- <a id="R">**R** - R NLP Libraries</a> | [Back to Top](#contents)
  * [tidytext](https://github.com/juliasilge/tidytext) ⭐ 1,203 | 🐛 8 | 🌐 R | 📅 2026-08-02 - Text mining using tidy tools
  ...
  * [spacyr](https://github.com/quanteda/spacyr) ⭐ 254 | 🐛 24 | 🌐 R | 📅 2025-02-03 - R wrapper to spaCy NLP
  ...
  * [CRAN Task View: Natural Language Processing](https://github.com/cran-task-views/NaturalLanguageProcessing/) ⭐ 6 | 🐛 6 | 📅 2026-04-18
...
- <a id="clojure">**Clojure**</a> | [Back to Top](#contents)
  ...
  * [postagga](https://github.com/fekr/postagga) ⭐ 163 | 🐛 12 | 🌐 Clojure | 📅 2020-12-15 - A library to parse natural language in Clojure and ClojureScript

- <a id="go">**Go**</a> | [Back to Top](#contents)
  * [prose](https://github.com/jdkato/prose) ⭐ 3,090 | 🐛 20 | 🌐 Go | 📅 2026-07-29 - Text processing library supporting tokenization, part-of-speech tagging, and named-entity extraction.
  * [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,646 | 🐛 0 | 🌐 Go | 📅 2026-07-20 - Go implementation of the jieba Chinese word segmentation algorithm.
  * [kagome](https://github.com/ikawaha/kagome) ⭐ 983 | 🐛 0 | 🌐 Go | 📅 2026-09-19 - Japanese morphological analyzer written in pure Go.
  * [go-propisyu](https://github.com/rekurt/go-propisyu) ⭐ 5 | 🐛 3 | 🌐 Go | 📅 2026-09-05 - Converts numbers to Russian words with correct grammatical gender and noun declension.
...
- <a id="NLP++">**NLP++** - NLP++ Language</a> | [Back to Top](#contents)
  * [nlp-engine](https://github.com/VisualText/nlp-engine) ⭐ 24 | 🐛 82 | 🌐 C++ | 📅 2026-09-21 - NLP++ engine to run NLP++ code on Linux including a full English parser
...
- <a id="julia">**Julia**</a> | [Back to Top](#contents)
  ...
  * [WordTokenizers](https://github.com/JuliaText/WordTokenizers.jl) ⭐ 100 | 🐛 12 | 🌐 Julia | 📅 2021-12-30 - High performance tokenizers for natural language processing and other related tasks
  * [Word2Vec](https://github.com/JuliaText/Word2Vec.jl) ⭐ 62 | 🐛 7 | 🌐 Julia | 📅 2021-11-15 - Julia interface to word2vec
  * [Languages](https://github.com/JuliaText/Languages.jl) ⭐ 57 | 🐛 7 | 🌐 Julia | 📅 2025-10-25 - A package for working with human languages
...
* [Wit-ai](https://github.com/wit-ai/wit) ⭐ 965 | 🐛 158 | 📅 2021-09-01 - Natural Language Interface for apps and devices
...
* [Label Studio](https://github.com/HumanSignal/label-studio) ⭐ 28,338 | 🐛 950 | 🌐 TypeScript | 📅 2026-09-23 - open-core multi-modal labeling platform; widely used for NLP labeling.
* [doccano](https://github.com/chakki-works/doccano) ⭐ 10,772 | 🐛 398 | 🌐 Python | 📅 2026-04-14 - doccano is free, open-source, and provides annotation features for text classification, sequence labeling and sequence to sequence
* [Argilla](https://github.com/argilla-io/argilla) ⭐ 5,122 | 🐛 34 | 🌐 Python | 📅 2026-09-21 - open-source platform for collecting human feedback, building NLP and LLM datasets, and curating preference data.
* [Potato](https://github.com/davidjurgens/potato) ⭐ 424 | 🐛 1 | 🌐 Python | 📅 2026-09-23 - Free, open-source annotation tool covering 21+ task types (classification, span, coreference, entity linking, agent trace evaluation) with built-in MACE quality control, attention checks, AI-assisted labeling, and 300+ example tasks.
...
* [Shoonya](https://github.com/AI4Bharat/Shoonya-Backend) ⭐ 28 | 🐛 47 | 🌐 Python | 📅 2026-09-23 - Shoonya is free and open source data annotation platform with wide varities of organization and workspace level management system. Shoonya is data agnostic, can be used by teams to annotate data with various level of verification stages at scale.
...
Modern sentence and document embeddings: see [Retrieval for NLP](#retrieval-for-nlp) (Sentence-Transformers, E5, BGE-M3, Nomic, GritLM) and [MTEB](https://github.com/embeddings-benchmark/mteb) ⭐ 3,433 | 🐛 329 | 🌐 Python | 📅 2026-09-23 for current leaderboards.

### Tokenization, Morphology, and Segmentation

[Back to Top](#contents)

* [SentencePiece](https://github.com/google/sentencepiece) ⭐ 12,094 | 🐛 5 | 🌐 C++ | 📅 2026-09-22 - language-agnostic subword tokenization.

* [SentencePiece](https://github.com/google/sentencepiece) ⭐ 12,094 | 🐛 5 | 🌐 C++ | 📅 2026-09-22 - language-agnostic subword tokenization (BPE and Unigram).

* [Tokenizers](https://github.com/huggingface/tokenizers) ⭐ 11,102 | 🐛 208 | 🌐 Rust | 📅 2026-09-23 - fast Rust implementations of BPE, WordPiece, Unigram.

* [Stanza](https://github.com/stanfordnlp/stanza) ⭐ 7,882 | 🐛 95 | 🌐 Python | 📅 2026-09-23 - tokenization, lemma, and morphology for 70+ languages.

* [UDPipe](https://github.com/ufal/udpipe) ⭐ 421 | 🐛 15 | 🌐 C++ | 📅 2026-06-11 - tokenization, tagging, lemmatization, parsing for Universal Dependencies.
...
* [spaCy](https://spacy.io/) and [Stanza](https://github.com/stanfordnlp/stanza) ⭐ 7,882 | 🐛 95 | 🌐 Python | 📅 2026-09-23 - production parsers across many languages.
...
* [Flair](https://github.com/flairNLP/flair) ⭐ 14,389 | 🐛 31 | 🌐 Python | 📅 2025-10-27 - contextual string embeddings, strong NER across languages.
...
* [maverick-coref](https://github.com/SapienzaNLP/maverick-coref) ⭐ 70 | 🐛 5 | 🌐 Python | 📅 2025-06-10 (2024) - efficient coreference matching the best larger systems.
...
* [SetFit](https://github.com/huggingface/setfit) ⭐ 2,817 | 🐛 157 | 🌐 Jupyter Notebook | 📅 2026-09-23 - few-shot text classification without prompts.
* [PySS3](https://github.com/sergioburdisso/pyss3) ⭐ 350 | 🐛 6 | 🌐 Python | 📅 2025-10-16 - white-box, interpretable text classifier.
* [FastFit](https://github.com/IBM/fastfit) ⭐ 220 | 🐛 14 | 🌐 Python | 📅 2025-09-18 - fast few-shot for many-class settings.
...
* [BERTopic](https://github.com/MaartenGr/BERTopic) ⭐ 7,851 | 🐛 474 | 🌐 Python | 📅 2026-09-22 - clustering-based topic modeling on top of contextual embeddings; common modern default.
* [Top2Vec](https://github.com/ddangelov/Top2Vec) ⭐ 3,108 | 🐛 84 | 🌐 Python | 📅 2024-11-14 - jointly learns topic and document vectors.
...
* [Marian NMT](https://github.com/marian-nmt/marian) ⭐ 1,473 | 🐛 97 | 🌐 C++ | 📅 2023-08-25 - efficient C++ NMT framework.
...
* [BERTScore](https://github.com/Tiiiger/bert_score) ⭐ 1,919 | 🐛 46 | 🌐 Jupyter Notebook | 📅 2024-07-30 - similarity-based generation metric.
* [sacrebleu](https://github.com/mjpost/sacrebleu) ⭐ 1,259 | 🐛 23 | 🌐 Python | 📅 2026-08-20 - reproducible BLEU/chrF/TER scoring.
* [COMET](https://github.com/Unbabel/COMET) ⭐ 779 | 🐛 64 | 🌐 Python | 📅 2026-04-21 - learned MT metric; current de-facto standard alongside chrF.
...
* [Document-QA](https://github.com/allenai/document-qa) ⭐ 435 | 🐛 30 | 🌐 Python | 📅 2024-02-04 - multi-paragraph reading comprehension.
...
* [BGE](https://github.com/FlagOpen/FlagEmbedding) ⭐ 12,186 | 🐛 910 | 🌐 Python | 📅 2026-08-24 and [BGE-M3](https://arxiv.org/abs/2402.03216) (2024) - multilingual, multi-functionality embeddings; top of MTEB across languages.
...
* [Whisper](https://github.com/openai/whisper) ⭐ 109,506 | 🐛 151 | 🌐 Python | 📅 2026-08-31 - multilingual ASR; the modern open default.
* [Coqui TTS](https://github.com/coqui-ai/TTS) ⭐ 46,052 | 🐛 3 | 🌐 Python | 📅 2024-08-16 and [VieNeu-TTS](https://github.com/pnnbao97/VieNeu-TTS) ⭐ 2,649 | 🐛 12 | 🌐 Python | 📅 2026-09-23 - open TTS.
* [FunASR](https://github.com/modelscope/FunASR) ⭐ 20,478 | 🐛 35 | 🌐 Python | 📅 2026-09-21 - industrial-grade ASR toolkit; 170× realtime on GPU, 50+ languages, built-in VAD, punctuation, speaker diarization, and emotion detection. Includes non-autoregressive SenseVoice and LLM-based Fun-ASR-Nano models.
* [SeamlessM4T](https://github.com/facebookresearch/seamless_communication) ⭐ 11,863 | 🐛 253 | 🌐 Jupyter Notebook | 📅 2026-09-08 - unified speech and text translation.
...
* [nlp-datasets](https://github.com/niderhoff/nlp-datasets) ⭐ 6,000 | 🐛 12 | 📅 2023-02-15 - large collection of NLP datasets.
* [gensim-data](https://github.com/RaRe-Technologies/gensim-data) ⭐ 1,057 | 🐛 20 | 🌐 Python | 📅 2018-03-16 - data repository for pretrained NLP models and NLP corpora.
...
* [RedPajama / RedPajama-V2](https://github.com/togethercomputer/RedPajama-Data) ⭐ 4,989 | 🐛 43 | 🌐 Python | 📅 2026-06-03 (2023-2024) - reproductions of LLaMA pretraining data; V2 is 30T tokens with quality signals.
* [Dolma](https://github.com/allenai/dolma) ⭐ 1,545 | 🐛 26 | 🌐 Python | 📅 2026-08-24 (AI2, 2023-2024) - 3T-token open pretraining corpus with documented filtering pipeline.
...
* [UDPipe](https://github.com/ufal/udpipe) ⭐ 421 | 🐛 15 | 🌐 C++ | 📅 2026-06-11 is a trainable pipeline for tokenizing, tagging, lemmatizing and parsing Universal Treebanks and other CoNLL-U files. Primarily written in C++, offers a fast and reliable solution for multilingual NLP processing.
...
* [MTEB](https://github.com/embeddings-benchmark/mteb) ⭐ 3,433 | 🐛 329 | 🌐 Python | 📅 2026-09-23 - Massive Text Embedding Benchmark; standard for sentence/document encoders.
* [BEIR](https://github.com/beir-cellar/beir) ⭐ 2,295 | 🐛 83 | 🌐 Python | 📅 2025-10-16 - heterogeneous IR benchmark for retrieval models.
...
* [LM Evaluation Harness](https://github.com/EleutherAI/lm-evaluation-harness) ⭐ 14,061 | 🐛 1,019 | 🌐 Python | 📅 2026-09-14 - unified framework for LM benchmark evaluation.
* [BIG-bench](https://github.com/google/BIG-bench) ⚠️ Archived - 200+ tasks probing language model capabilities.
* [MMLU](https://github.com/hendrycks/test) ⭐ 1,617 | 🐛 17 | 🌐 Python | 📅 2023-05-28 - multitask knowledge evaluation across 57 subjects.
...
* [Needle in a Haystack](https://github.com/gkamradt/LLMTest_NeedleInAHaystack) ⭐ 2,385 | 🐛 29 | 🌐 Jupyter Notebook | 📅 2026-06-08 - retrieval probe for long-context windows.
* [LongBench](https://github.com/THUDM/LongBench) ⭐ 1,238 | 🐛 68 | 🌐 Python | 📅 2025-01-15 - bilingual long-context benchmark across NLP tasks.
...
* [RAGAS](https://github.com/explodinggradients/ragas) ⭐ 15,831 | 🐛 609 | 🌐 Python | 📅 2026-02-24 - reference-free evaluation for RAG and QA pipelines.
* [TruthfulQA](https://github.com/sylinrl/TruthfulQA) ⭐ 947 | 🐛 21 | 🌐 Jupyter Notebook | 📅 2025-01-16 - benchmark for truthfulness in question answering.
* [SelfCheckGPT](https://github.com/potsawee/selfcheckgpt) ⭐ 631 | 🐛 3 | 🌐 Python | 📅 2024-06-26 - sampling-based hallucination detection.
...
* [GTE](https://huggingface.co/thenlper/gte-base), [BGE](https://github.com/FlagOpen/FlagEmbedding) ⭐ 12,186 | 🐛 910 | 🌐 Python | 📅 2026-08-24, and [Stella](https://huggingface.co/dunzhang/stella_en_1.5B_v5) - compact text embedding models near the top of MTEB.
* [SetFit](https://github.com/huggingface/setfit) ⭐ 2,817 | 🐛 157 | 🌐 Jupyter Notebook | 📅 2026-09-23 - few-shot text classification without prompts.
* [FastFit](https://github.com/IBM/fastfit) ⭐ 220 | 🐛 14 | 🌐 Python | 📅 2025-09-18 - fast few-shot classification for many-class settings.
...
* [GGUF / llama.cpp](https://github.com/ggerganov/llama.cpp) ⭐ 129,299 | 🐛 2,520 | 🌐 C++ | 📅 2026-09-23 - portable quantized inference.
* [vLLM](https://github.com/vllm-project/vllm) ⭐ 92,518 | 🐛 8,374 | 🌐 Python | 📅 2026-09-23 - PagedAttention-based high-throughput LM serving.
* [SGLang](https://github.com/sgl-project/sglang) ⭐ 36,373 | 🐛 5,359 | 🌐 Python | 📅 2026-09-23 - structured generation and efficient serving.
...
* [PEFT](https://github.com/huggingface/peft) ⭐ 21,718 | 🐛 77 | 🌐 Python | 📅 2026-09-23 - HuggingFace library bundling LoRA, prefix tuning, IA3, and others.
...
* [TRL](https://github.com/huggingface/trl) ⭐ 19,367 | 🐛 273 | 🌐 Python | 📅 2026-09-23 - reference library for SFT, DPO, GRPO, and RLHF.
* [Self-Instruct](https://github.com/yizhongw/self-instruct) ⭐ 4,611 | 🐛 13 | 🌐 Python | 📅 2023-03-27 - bootstrapping instruction data from LMs.
* [Super-NaturalInstructions](https://github.com/allenai/natural-instructions) ⭐ 1,049 | 🐛 78 | 🌐 Python | 📅 2023-12-11 - 1600+ NLP tasks with instructions.
...
* [CrowS-Pairs](https://github.com/nyu-mll/crows-pairs) ⭐ 139 | 🐛 5 | 🌐 HTML | 📅 2024-03-01 - social bias measurement in masked LMs.
...
* [CAMeL Tools](https://github.com/CAMeL-Lab/camel_tools) ⭐ 579 | 🐛 35 | 🌐 Python | 📅 2026-06-08 - Python toolkit for Arabic NLP including dialect ID, morphology, NER.
...
* [AraBERT](https://github.com/aub-mind/arabert) ⭐ 732 | 🐛 2 | 🌐 Python | 📅 2022-10-17 - Arabic BERT family.
* [AraELECTRA](https://aclanthology.org/2021.wanlp-1.20/) - efficient Arabic pretraining (released alongside [AraBERT](https://github.com/aub-mind/arabert) ⭐ 732 | 🐛 2 | 🌐 Python | 📅 2022-10-17).
* [CAMeLBERT](https://github.com/CAMeL-Lab/CAMeLBERT) ⭐ 59 | 🐛 3 | 🌐 Python | 📅 2024-06-21 - BERT models for MSA, dialectal, and Classical Arabic.
...
* [HanLP](https://github.com/hankcs/HanLP) ⭐ 36,501 | 🐛 12 | 🌐 Python | 📅 2026-09-15 - multilingual NLP library with strong Chinese support.
* [jieba](https://github.com/fxsjy/jieba#jieba-1) ⭐ 35,167 | 🐛 700 | 🌐 Python | 📅 2024-08-21 - Python package for Chinese word segmentation.
* [SnowNLP](https://github.com/isnowfy/snownlp) ⭐ 6,633 | 🐛 44 | 🌐 Python | 📅 2020-01-19 - Python package for Chinese NLP.
* [LTP](https://github.com/HIT-SCIR/ltp) ⭐ 5,262 | 🐛 76 | 🌐 Python | 📅 2026-03-11 - HIT Language Technology Platform: segmentation, POS, NER, parsing.
* [FudanNLP](https://github.com/FudanNLP/fnlp) ⭐ 2,683 | 🐛 43 | 🌐 Java | 📅 2023-11-17 - Java library for Chinese text processing.

### Models and Embeddings

* [DeepSeek-V3](https://github.com/deepseek-ai/DeepSeek-V3) ⭐ 104,479 | 🐛 252 | 🌐 Python | 📅 2025-08-28 - efficient open MoE model with strong Chinese.
* [Qwen 2.5 / Qwen 3](https://github.com/QwenLM/Qwen3) ⭐ 27,653 | 🐛 68 | 🌐 Python | 📅 2026-01-09 - Alibaba's open Chinese-strong LM family.
* [ChatGLM3 / GLM-4](https://github.com/THUDM/ChatGLM3) ⭐ 13,646 | 🐛 35 | 🌐 Python | 📅 2025-01-13 - Tsinghua's bilingual Chinese-English LMs.
* [Chinese-BERT-wwm](https://github.com/ymcui/Chinese-BERT-wwm) ⭐ 10,232 | 🐛 1 | 🌐 Python | 📅 2026-04-19 - whole-word masking BERT for Chinese.
* [Yi](https://github.com/01-ai/Yi) ⭐ 7,833 | 🐛 31 | 🌐 Jupyter Notebook | 📅 2024-11-27 - 01.AI's bilingual open LMs.
* [Baichuan 2](https://github.com/baichuan-inc/Baichuan2) ⭐ 4,082 | 🐛 281 | 🌐 Python | 📅 2024-11-08 - open Chinese LM.
* [MacBERT](https://github.com/ymcui/MacBERT) ⭐ 722 | 🐛 0 | 📅 2026-04-19 - improved Chinese BERT with MLM-as-correction pretraining.

### Anthology

* [funNLP](https://github.com/fighting41love/funNLP) ⭐ 83,358 | 🐛 54 | 🌐 Python | 📅 2024-05-10 - large collection of Chinese NLP tools and resources.
...
* [Awesome Danish](https://github.com/fnielsen/awesome-danish) ⭐ 198 | 🐛 0 | 📅 2024-12-11 - curated list of resources for Danish language technology.
...
* [Kaldi NL](https://github.com/opensource-spraakherkenning-nl/Kaldi_NL) ⭐ 69 | 🐛 8 | 🌐 Shell | 📅 2023-11-01 - Dutch speech-recognition models based on [Kaldi](http://kaldi-asr.org/).
...
* [Alpino](https://github.com/rug-compling/alpino) ⭐ 31 | 🐛 2 | 🌐 Prolog | 📅 2026-09-16 - dependency parser for Dutch (also does POS tagging and lemmatization).
...
* [German-NLP](https://github.com/adbar/German-NLP) ⭐ 534 | 🐛 1 | 📅 2026-09-11 - curated list of open-access, open-source, and off-the-shelf resources and tools developed with a focus on German.
...
* [Hindi and Bengali Word2Vec](https://github.com/Kyubyong/wordvectors) ⭐ 2,233 | 🐛 19 | 🌐 Python | 📅 2018-10-11
...
* [iNLTK](https://github.com/goru001/inltk) ⭐ 839 | 🐛 39 | 🌐 Python | 📅 2024-01-20 - NLP toolkit for Indic languages on PyTorch/Fastai.
* [Indic NLP Library](https://github.com/anoopkunchukuttan/indic_nlp_library) ⭐ 648 | 🐛 34 | 🌐 Python | 📅 2024-06-07 - tokenization, transliteration, MT helpers across 18 Indic languages.
...
* [IndicTrans2](https://github.com/AI4Bharat/IndicTrans2) ⭐ 475 | 🐛 17 | 🌐 Python | 📅 2025-10-03 (2023-2024) - high-quality MT for 22 Indic languages.
* [IndicBERT v2](https://github.com/AI4Bharat/IndicBERT) ⭐ 123 | 🐛 17 | 🌐 Python | 📅 2025-04-06 (2022-2024) - multilingual BERT for 23 Indic languages.
...
* [PySastrawi](https://github.com/har07/PySastrawi) ⭐ 363 | 🐛 12 | 🌐 Python | 📅 2026-05-21 - Python stemmer for Bahasa Indonesia based on the Sastrawi stemming algorithm.
...
* [IndoBERT (IndoNLU)](https://github.com/indobenchmark/indonlu) ⭐ 656 | 🐛 6 | 🌐 Jupyter Notebook | 📅 2024-11-16 - pretrained Indonesian LM with the IndoNLU benchmark suite.
* [SEA-LION](https://github.com/aisingapore/sealion) ⭐ 424 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2026-09-21 (2024) - Singapore AI's open Southeast-Asian LM with strong Indonesian.
* [NusaCrowd / Cendol](https://github.com/IndoNLP/nusa-crowd) ⭐ 292 | 🐛 37 | 🌐 Jupyter Notebook | 📅 2024-06-02 (2023-2024) - large-scale community datasets and Cendol instruction-tuned LMs for Indonesian and regional languages.
* [Sailor](https://github.com/sail-sg/sailor-llm) ⭐ 139 | 🐛 0 | 🌐 Python | 📅 2024-12-21 - open Southeast-Asian LMs covering Indonesian.
* [IndoBERT (IndoLEM)](https://github.com/indolem/indolem) ⭐ 112 | 🐛 4 | 🌐 Python | 📅 2020-12-14 - alternative IndoBERT with the IndoLEM benchmark.

### Datasets

* [SEACrowd](https://github.com/SEACrowd/seacrowd-datahub) ⭐ 107 | 🐛 93 | 🌐 Python | 📅 2026-03-16 - A multilingual and multimodal data hub providing standardized datasets and benchmarks for Southeast Asian NLP (EMNLP 2024).
...
* [Kiwi](https://github.com/bab2min/Kiwi) ⭐ 782 | 🐛 18 | 🌐 C++ | 📅 2026-09-15 - fast Korean morphological analyzer.
* [kss](https://github.com/hyunwoongko/kss) ⭐ 469 | 🐛 6 | 🌐 Python | 📅 2025-11-13 - Korean sentence splitter.
* [Garu](https://github.com/ongjin/garu) ⭐ 177 | 🐛 0 | 🌐 Python | 📅 2026-09-21 - browser-native Korean morphological analyzer running fully client-side via WebAssembly (1MB model, offline, MIT).
...
* [KLUE-RoBERTa](https://github.com/KLUE-benchmark/KLUE) ⭐ 606 | 🐛 19 | 📅 2026-06-30 - models trained on the KLUE benchmark.
...
* [Naver Sentiment Movie Corpus in Korean](https://github.com/e9t/nsmc/) ⭐ 608 | 🐛 2 | 🌐 Python | 📅 2017-03-07
...
* [Hazm](https://github.com/roshan-research/hazm) ⭐ 1,426 | 🐛 8 | 🌐 Python | 📅 2026-04-01 - Persian NLP toolkit.
* [Parsivar](https://github.com/ICTRC/Parsivar) ⭐ 248 | 🐛 29 | 🌐 Python | 📅 2024-01-02 - Persian language processing toolkit.
...
* [Perke](https://github.com/AlirezaTheH/perke) ⭐ 74 | 🐛 2 | 🌐 Python | 📅 2026-08-31 - Persian keyphrase extraction.
* [Perstem](https://github.com/jonsafari/perstem) ⭐ 21 | 🐛 1 | 🌐 Perl | 📅 2016-03-30 - Persian stemmer, morphological analyzer, and partial POS tagger.

### Models

* [ParsBERT](https://github.com/hooshvare/parsbert) ⭐ 430 | 🐛 12 | 🌐 Jupyter Notebook | 📅 2023-06-12 - Persian BERT.
...
* [Polish-NLP](https://github.com/ksopyla/awesome-nlp-polish) ⭐ 308 | 🐛 0 | 📅 2021-08-08 - curated list of resources dedicated to Polish NLP: models, tools, and datasets.
...
* [Portuguese-nlp](https://github.com/ajdavidl/Portuguese-NLP) ⭐ 373 | 🐛 1 | 📅 2026-06-25 - curated list of Portuguese NLP resources and tools.

### Models

* [BERTimbau](https://github.com/neuralmind-ai/portuguese-bert) ⭐ 886 | 🐛 20 | 🌐 Python | 📅 2024-06-17 - BERT for Brazilian Portuguese.
...
* [BETO](https://github.com/dccuchile/beto) ⭐ 507 | 🐛 10 | 📅 2023-10-21 - BERT for Spanish.
...
* [PyThaiNLP](https://github.com/PyThaiNLP/pythainlp) ⭐ 1,156 | 🐛 29 | 🌐 Python | 📅 2026-09-20 - Thai NLP in Python.
...
* [WangchanBERTa](https://github.com/vistec-AI/thai2transformers) ⭐ 124 | 🐛 12 | 🌐 Jupyter Notebook | 📅 2023-11-06 - pretrained Thai language model.
...
* [Prime Minister 29](https://github.com/PyThaiNLP/lexicon-thai/tree/master/thai-corpus/Prime%20Minister%2029) ⭐ 147 | 🐛 0 | 🌐 Python | 📅 2024-02-13 - dataset of speeches by the current Prime Minister of Thailand.
...
* [UkrainianLT](https://github.com/Helsinki-NLP/UkrainianLT) ⭐ 41 | 🐛 1 | 📅 2022-04-27 - curated list focused on machine translation and speech processing.
...
* [urduhack](https://github.com/urduhack/urduhack) ⭐ 307 | 🐛 17 | 🌐 Python | 📅 2024-01-04 - NLP library for Urdu.
...
* [SOAS English-Uzbek RAG Evaluation](https://github.com/rajantripathi/soas-rag-evaluation) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-09-05 - Bilingual retrieval-evaluation benchmark for culturally grounded RAG. 400 rows, EN+UZ, MIT/CC-BY-4.0.
...
* [VieNeu-TTS](https://github.com/pnnbao97/VieNeu-TTS) ⭐ 2,649 | 🐛 12 | 🌐 Python | 📅 2026-09-23 - on-device Vietnamese text-to-speech with voice cloning.
* [underthesea](https://github.com/undertheseanlp/underthesea) ⭐ 1,807 | 🐛 37 | 🌐 Python | 📅 2026-09-22 - Vietnamese NLP toolkit.
* [VnCoreNLP](https://github.com/vncorenlp/VnCoreNLP) ⭐ 679 | 🐛 4 | 🌐 Java | 📅 2023-02-12 - Vietnamese NLP toolkit.
...
* [PhoGPT](https://github.com/VinAIResearch/PhoGPT) ⭐ 795 | 🐛 3 | 🌐 Python | 📅 2024-11-12 (VinAI, 2023-2024) - open generative LM for Vietnamese.
...
* [EVB Corpus](https://github.com/qhungngo/EVBCorpus) ⭐ 53 | 🐛 1 | 📅 2019-07-12 - 20M words across 15 bilingual books, 100 parallel English-Vietnamese texts, 250 parallel law texts, 5K news articles, and 2K film subtitles.
...
* Ancient Languages: [CLTK](https://github.com/cltk/cltk) ⭐ 921 | 🐛 4 | 🌐 Python | 📅 2026-08-01: The Classical Language Toolkit is a Python library and collection of texts for doing NLP in ancient languages
...
* [awesome-llm](https://github.com/Hannibal046/Awesome-LLM) ⭐ 27,422 | 🐛 466 | 📅 2025-07-31 - general-purpose large language model resources.
* [awesome-mlops](https://github.com/visenger/awesome-mlops) ⭐ 14,221 | 🐛 47 | 📅 2024-11-21 - production ML, including LLM serving.
* [awesome-generative-ai](https://github.com/steven2358/awesome-generative-ai) ⭐ 12,669 | 🐛 718 | 📅 2026-09-16 - generative AI across modalities.
* [awesome-prompt-engineering](https://github.com/promptslab/Awesome-Prompt-Engineering) ⭐ 6,339 | 🐛 117 | 🌐 TypeScript | 📅 2026-09-23 - prompting techniques and template libraries.
* [awesome-rag](https://github.com/Danielskry/Awesome-RAG) ⭐ 1,376 | 🐛 110 | 📅 2026-09-23 - retrieval-augmented generation systems and tooling.
