...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 495,164 | 🐛 100 | 📅 2026-06-30
...
*Please read the [contribution guidelines](contributing.md) before contributing. Please add your favourite NLP resource by raising a [pull request](https://github.com/keonkim/awesome-nlp/pulls) ⭐ 18,901 | 🐛 7 | 📅 2026-07-11*
...
* [Deep NLP Course](https://github.com/yandexdataschool/nlp_course) ⭐ 10,650 | 🐛 9 | 🌐 Jupyter Notebook | 📅 2026-06-01 by Yandex Data School, covering important ideas from text embedding to machine translation including sequence modeling, language models and so on.
...
* <a id="node-js">**Node.js and Javascript** - Node.js Libaries for NLP</a> | [Back to Top](#contents)
  * [NLP Compromise](https://github.com/spencermountain/compromise) ⭐ 12,147 | 🐛 118 | 🌐 JavaScript | 📅 2026-07-20 - Natural Language processing in the browser
...
* <a id="python"> **Python** - Python NLP Libraries</a> | [Back to Top](#contents)
  * [Transformers](https://github.com/huggingface/transformers) ⭐ 164,049 | 🐛 2,380 | 🌐 Python | 📅 2026-08-13 - Natural Language Processing for TensorFlow 2.0 and PyTorch.
  * [spaCy](https://github.com/explosion/spaCy) ⭐ 33,814 | 🐛 231 | 🌐 Python | 📅 2026-08-07 - Industrial strength NLP with Python and Cython :+1:
  ...
  * [Haystack](https://github.com/deepset-ai/haystack) ⭐ 26,193 | 🐛 98 | 🌐 Python | 📅 2026-08-13 - End-to-end Python framework for building natural language search interfaces to data. Leverages Transformers and the State-of-the-Art of NLP. Supports DPR, Elasticsearch, HuggingFace’s Modelhub, and much more!
  * [HuggingFace Datasets](https://github.com/huggingface/datasets) ⭐ 21,835 | 🐛 1,272 | 🌐 Python | 📅 2026-08-12 - standardized loaders and processing for thousands of NLP datasets.
  * [Sentence-Transformers](https://github.com/UKPLab/sentence-transformers) ⭐ 18,995 | 🐛 1,307 | 🌐 Python | 📅 2026-08-13 - sentence/document embeddings, semantic search, and re-ranking; current standard for retrieval-style NLP.
  ...
  * [Tokenizers](https://github.com/huggingface/tokenizers) ⭐ 10,961 | 🐛 253 | 🌐 Rust | 📅 2026-08-13 - Tokenizers optimized for Research and Production.
  ...
  * [Stanza](https://github.com/stanfordnlp/stanza) ⭐ 7,860 | 🐛 92 | 🌐 Python | 📅 2026-08-13 - Stanford NLP's Python toolkit for tokenization, POS, lemma, dependency parsing, and NER across 70+ languages.
  * [Argilla](https://github.com/argilla-io/argilla) ⭐ 5,078 | 🐛 29 | 🌐 Python | 📅 2026-08-10 - open-source data annotation and feedback collection platform for LLM and NLP datasets.
  * [Snips NLU](https://github.com/snipsco/snips-nlu) ⭐ 3,972 | 🐛 67 | 🌐 Python | 📅 2023-05-22 - A production ready library for intent parsing
  * [TextAttack](https://github.com/QData/TextAttack) ⭐ 3,460 | 🐛 49 | 🌐 Python | 📅 2026-08-13 - Adversarial attacks, adversarial training, and data augmentation in NLP
  ...
  * [Pearmut](https://github.com/zouharvi/pearmut) ⭐ 32 | 🐛 8 | 🌐 Python | 📅 2026-08-11 - Human annotation tool for multilingual NLP tasks, such as machine translation.
...
- <a id="scala">**Scala** - Scala NLP Libraries</a> | [Back to Top](#contents)
  * [Spark NLP](https://github.com/JohnSnowLabs/spark-nlp) ⭐ 4,154 | 🐛 29 | 🌐 Scala | 📅 2026-08-11 - Spark NLP is a natural language processing library built on top of Apache Spark ML that provides simple, performant & accurate NLP annotations for machine learning pipelines that scale easily in a distributed environment.
...
- <a id="go">**Go**</a> | [Back to Top](#contents)
  ...
  * [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,648 | 🐛 0 | 🌐 Go | 📅 2026-07-20 - Go implementation of the jieba Chinese word segmentation algorithm.
...
* [Label Studio](https://github.com/HumanSignal/label-studio) ⭐ 28,042 | 🐛 922 | 🌐 TypeScript | 📅 2026-08-13 - open-core multi-modal labeling platform; widely used for NLP labeling.
* [doccano](https://github.com/chakki-works/doccano) ⭐ 10,737 | 🐛 396 | 🌐 Python | 📅 2026-04-14 - doccano is free, open-source, and provides annotation features for text classification, sequence labeling and sequence to sequence
* [Argilla](https://github.com/argilla-io/argilla) ⭐ 5,078 | 🐛 29 | 🌐 Python | 📅 2026-08-10 - open-source platform for collecting human feedback, building NLP and LLM datasets, and curating preference data.
...
* [Shoonya](https://github.com/AI4Bharat/Shoonya-Backend) ⭐ 28 | 🐛 46 | 🌐 Python | 📅 2026-08-13 - Shoonya is free and open source data annotation platform with wide varities of organization and workspace level management system. Shoonya is data agnostic, can be used by teams to annotate data with various level of verification stages at scale.
...
Modern sentence and document embeddings: see [Retrieval for NLP](#retrieval-for-nlp) (Sentence-Transformers, E5, BGE-M3, Nomic, GritLM) and [MTEB](https://github.com/embeddings-benchmark/mteb) ⭐ 3,390 | 🐛 333 | 🌐 Python | 📅 2026-08-13 for current leaderboards.

### Tokenization, Morphology, and Segmentation

[Back to Top](#contents)

* [SentencePiece](https://github.com/google/sentencepiece) ⭐ 12,019 | 🐛 4 | 🌐 C++ | 📅 2026-08-12 - language-agnostic subword tokenization.

* [SentencePiece](https://github.com/google/sentencepiece) ⭐ 12,019 | 🐛 4 | 🌐 C++ | 📅 2026-08-12 - language-agnostic subword tokenization (BPE and Unigram).

* [Tokenizers](https://github.com/huggingface/tokenizers) ⭐ 10,961 | 🐛 253 | 🌐 Rust | 📅 2026-08-13 - fast Rust implementations of BPE, WordPiece, Unigram.

* [Stanza](https://github.com/stanfordnlp/stanza) ⭐ 7,860 | 🐛 92 | 🌐 Python | 📅 2026-08-13 - tokenization, lemma, and morphology for 70+ languages.
...
* [spaCy](https://spacy.io/) and [Stanza](https://github.com/stanfordnlp/stanza) ⭐ 7,860 | 🐛 92 | 🌐 Python | 📅 2026-08-13 - production parsers across many languages.
...
* [BGE](https://github.com/FlagOpen/FlagEmbedding) ⭐ 12,043 | 🐛 907 | 🌐 Python | 📅 2026-04-22 and [BGE-M3](https://arxiv.org/abs/2402.03216) (2024) - multilingual, multi-functionality embeddings; top of MTEB across languages.
...
* [Whisper](https://github.com/openai/whisper) ⭐ 107,202 | 🐛 135 | 🌐 Python | 📅 2026-07-28 - multilingual ASR; the modern open default.
* [Coqui TTS](https://github.com/coqui-ai/TTS) ⭐ 45,889 | 🐛 4 | 🌐 Python | 📅 2024-08-16 and [VieNeu-TTS](https://github.com/pnnbao97/VieNeu-TTS) ⭐ 2,328 | 🐛 10 | 🌐 Python | 📅 2026-08-03 - open TTS.
* [FunASR](https://github.com/modelscope/FunASR) ⭐ 19,815 | 🐛 3 | 🌐 Python | 📅 2026-08-13 - industrial-grade ASR toolkit; 170× realtime on GPU, 50+ languages, built-in VAD, punctuation, speaker diarization, and emotion detection. Includes non-autoregressive SenseVoice and LLM-based Fun-ASR-Nano models.
...
* [MTEB](https://github.com/embeddings-benchmark/mteb) ⭐ 3,390 | 🐛 333 | 🌐 Python | 📅 2026-08-13 - Massive Text Embedding Benchmark; standard for sentence/document encoders.
...
* [LM Evaluation Harness](https://github.com/EleutherAI/lm-evaluation-harness) ⭐ 13,611 | 🐛 927 | 🌐 Python | 📅 2026-08-11 - unified framework for LM benchmark evaluation.
...
* [Needle in a Haystack](https://github.com/gkamradt/LLMTest_NeedleInAHaystack) ⭐ 2,363 | 🐛 28 | 🌐 Jupyter Notebook | 📅 2026-06-08 - retrieval probe for long-context windows.
* [LongBench](https://github.com/THUDM/LongBench) ⭐ 1,219 | 🐛 67 | 🌐 Python | 📅 2025-01-15 - bilingual long-context benchmark across NLP tasks.
...
* [RAGAS](https://github.com/explodinggradients/ragas) ⭐ 15,300 | 🐛 554 | 🌐 Python | 📅 2026-02-24 - reference-free evaluation for RAG and QA pipelines.
...
* [GTE](https://huggingface.co/thenlper/gte-base), [BGE](https://github.com/FlagOpen/FlagEmbedding) ⭐ 12,043 | 🐛 907 | 🌐 Python | 📅 2026-04-22, and [Stella](https://huggingface.co/dunzhang/stella_en_1.5B_v5) - compact text embedding models near the top of MTEB.
* [SetFit](https://github.com/huggingface/setfit) ⭐ 2,778 | 🐛 162 | 🌐 Jupyter Notebook | 📅 2026-05-26 - few-shot text classification without prompts.
...
* [GGUF / llama.cpp](https://github.com/ggerganov/llama.cpp) ⭐ 123,751 | 🐛 2,010 | 🌐 C++ | 📅 2026-08-13 - portable quantized inference.
* [vLLM](https://github.com/vllm-project/vllm) ⭐ 88,945 | 🐛 6,523 | 🌐 Python | 📅 2026-08-13 - PagedAttention-based high-throughput LM serving.
* [SGLang](https://github.com/sgl-project/sglang) ⭐ 31,741 | 🐛 4,895 | 🌐 Python | 📅 2026-08-13 - structured generation and efficient serving.
...
* [PEFT](https://github.com/huggingface/peft) ⭐ 21,540 | 🐛 70 | 🌐 Python | 📅 2026-08-12 - HuggingFace library bundling LoRA, prefix tuning, IA3, and others.

### Instruction Tuning and Preference Optimization

* [TRL](https://github.com/huggingface/trl) ⭐ 19,066 | 🐛 261 | 🌐 Python | 📅 2026-08-13 - reference library for SFT, DPO, GRPO, and RLHF.
...
* [jieba](https://github.com/fxsjy/jieba#jieba-1) ⭐ 35,112 | 🐛 700 | 🌐 Python | 📅 2024-08-21 - Python package for Chinese word segmentation.
* [SnowNLP](https://github.com/isnowfy/snownlp) ⭐ 6,632 | 🐛 44 | 🌐 Python | 📅 2020-01-19 - Python package for Chinese NLP.
* [LTP](https://github.com/HIT-SCIR/ltp) ⭐ 5,260 | 🐛 75 | 🌐 Python | 📅 2026-03-11 - HIT Language Technology Platform: segmentation, POS, NER, parsing.
* [FudanNLP](https://github.com/FudanNLP/fnlp) ⭐ 2,685 | 🐛 43 | 🌐 Java | 📅 2023-11-17 - Java library for Chinese text processing.

### Models and Embeddings

* [DeepSeek-V3](https://github.com/deepseek-ai/DeepSeek-V3) ⭐ 104,172 | 🐛 203 | 🌐 Python | 📅 2025-08-28 - efficient open MoE model with strong Chinese.
* [Qwen 2.5 / Qwen 3](https://github.com/QwenLM/Qwen3) ⭐ 27,505 | 🐛 63 | 🌐 Python | 📅 2026-01-09 - Alibaba's open Chinese-strong LM family.
...
* [Baichuan 2](https://github.com/baichuan-inc/Baichuan2) ⭐ 4,086 | 🐛 282 | 🌐 Python | 📅 2024-11-08 - open Chinese LM.
* [MacBERT](https://github.com/ymcui/MacBERT) ⭐ 718 | 🐛 0 | 📅 2026-04-19 - improved Chinese BERT with MLM-as-correction pretraining.

### Anthology

* [funNLP](https://github.com/fighting41love/funNLP) ⭐ 82,442 | 🐛 53 | 🌐 Python | 📅 2024-05-10 - large collection of Chinese NLP tools and resources.
...
* [IndicTrans2](https://github.com/AI4Bharat/IndicTrans2) ⭐ 457 | 🐛 16 | 🌐 Python | 📅 2025-10-03 (2023-2024) - high-quality MT for 22 Indic languages.
...
* [Kiwi](https://github.com/bab2min/Kiwi) ⭐ 766 | 🐛 15 | 🌐 C++ | 📅 2026-08-11 - fast Korean morphological analyzer.
...
* [ParsBERT](https://github.com/hooshvare/parsbert) ⭐ 424 | 🐛 12 | 🌐 Jupyter Notebook | 📅 2023-06-12 - Persian BERT.
...
* [ArmanPersoNERCorpus](https://github.com/HaniehP/PersianNER) ⭐ 61 | 🐛 1 | 📅 2020-07-23 - 250K tokens, 7,682 sentences with NER tags in IOB format.
...
* [PyThaiNLP](https://github.com/PyThaiNLP/pythainlp) ⭐ 1,148 | 🐛 33 | 🌐 Python | 📅 2026-08-08 - Thai NLP in Python.
...
* [VieNeu-TTS](https://github.com/pnnbao97/VieNeu-TTS) ⭐ 2,328 | 🐛 10 | 🌐 Python | 📅 2026-08-03 - on-device Vietnamese text-to-speech with voice cloning.
* [underthesea](https://github.com/undertheseanlp/underthesea) ⭐ 1,802 | 🐛 51 | 🌐 Python | 📅 2026-08-13 - Vietnamese NLP toolkit.
...
* [PhoBERT](https://github.com/VinAIResearch/PhoBERT) ⭐ 799 | 🐛 4 | 📅 2026-08-04 - pretrained LM for Vietnamese.
...
* [BARTpho](https://github.com/VinAIResearch/BARTpho) ⭐ 105 | 🐛 0 | 📅 2024-07-22 - sequence-to-sequence pretrained model for Vietnamese.
...
* [awesome-llm](https://github.com/Hannibal046/Awesome-LLM) ⭐ 27,256 | 🐛 438 | 📅 2025-07-31 - general-purpose large language model resources.
* [awesome-mlops](https://github.com/visenger/awesome-mlops) ⭐ 14,156 | 🐛 44 | 📅 2024-11-21 - production ML, including LLM serving.
* [awesome-generative-ai](https://github.com/steven2358/awesome-generative-ai) ⭐ 12,491 | 🐛 562 | 📅 2026-08-03 - generative AI across modalities.
* [awesome-prompt-engineering](https://github.com/promptslab/Awesome-Prompt-Engineering) ⭐ 6,246 | 🐛 104 | 🌐 TypeScript | 📅 2026-08-13 - prompting techniques and template libraries.
* [awesome-rag](https://github.com/Danielskry/Awesome-RAG) ⭐ 1,335 | 🐛 88 | 📅 2026-07-09 - retrieval-augmented generation systems and tooling.
