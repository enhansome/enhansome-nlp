...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 506,587 | 🐛 106 | 📅 2026-09-02
...
*Please read the [contribution guidelines](contributing.md) before contributing. Please add your favourite NLP resource by raising a [pull request](https://github.com/keonkim/awesome-nlp/pulls) ⭐ 19,002 | 🐛 17 | 📅 2026-09-07*
...
* [Deep NLP Course](https://github.com/yandexdataschool/nlp_course) ⭐ 10,682 | 🐛 9 | 🌐 Jupyter Notebook | 📅 2026-09-11 by Yandex Data School, covering important ideas from text embedding to machine translation including sequence modeling, language models and so on.
...
* <a id="python"> **Python** - Python NLP Libraries</a> | [Back to Top](#contents)
  * [Transformers](https://github.com/huggingface/transformers) ⭐ 166,247 | 🐛 2,430 | 🌐 Python | 📅 2026-09-16 - Natural Language Processing for TensorFlow 2.0 and PyTorch.
  * [spaCy](https://github.com/explosion/spaCy) ⭐ 33,900 | 🐛 240 | 🌐 Python | 📅 2026-08-24 - Industrial strength NLP with Python and Cython :+1:
  ...
  * [Haystack](https://github.com/deepset-ai/haystack) ⭐ 26,522 | 🐛 151 | 🌐 Python | 📅 2026-09-16 - End-to-end Python framework for building natural language search interfaces to data. Leverages Transformers and the State-of-the-Art of NLP. Supports DPR, Elasticsearch, HuggingFace’s Modelhub, and much more!
  * [HuggingFace Datasets](https://github.com/huggingface/datasets) ⭐ 21,977 | 🐛 1,376 | 🌐 Python | 📅 2026-09-11 - standardized loaders and processing for thousands of NLP datasets.
  * [Sentence-Transformers](https://github.com/UKPLab/sentence-transformers) ⭐ 19,099 | 🐛 1,302 | 🌐 Python | 📅 2026-09-16 - sentence/document embeddings, semantic search, and re-ranking; current standard for retrieval-style NLP.
  ...
  * [Tokenizers](https://github.com/huggingface/tokenizers) ⭐ 11,040 | 🐛 258 | 🌐 Rust | 📅 2026-09-16 - Tokenizers optimized for Research and Production.
  ...
  * [Stanza](https://github.com/stanfordnlp/stanza) ⭐ 7,876 | 🐛 95 | 🌐 Python | 📅 2026-09-10 - Stanford NLP's Python toolkit for tokenization, POS, lemma, dependency parsing, and NER across 70+ languages.
  ...
  * [HuggingFace Evaluate](https://github.com/huggingface/evaluate) ⭐ 2,481 | 🐛 310 | 🌐 Python | 📅 2026-07-06 - reference implementations for NLP metrics.
  ...
  * [yasbd-lib](https://github.com/speedyk-005/yasbd-lib) ⭐ 29 | 🐛 9 | 🌐 Python | 📅 2026-09-15 - High-accuracy, rule-based sentence boundary detector (SBD). Drop-in pysbd adapter, streaming APIs, CLI, and a spaCy component across 39+ languages.
...
- <a id="kotlin">**Kotlin** - Kotlin NLP Libraries</a> | [Back to Top](#contents)
  * [Lingua](https://github.com/pemistahl/lingua/) ⭐ 821 | 🐛 13 | 🌐 Kotlin | 📅 2025-03-21 A language detection library for Kotlin and Java, suitable for long and short text alike
...
- <a id="scala">**Scala** - Scala NLP Libraries</a> | [Back to Top](#contents)
  * [Spark NLP](https://github.com/JohnSnowLabs/spark-nlp) ⭐ 4,159 | 🐛 34 | 🌐 Scala | 📅 2026-09-12 - Spark NLP is a natural language processing library built on top of Apache Spark ML that provides simple, performant & accurate NLP annotations for machine learning pipelines that scale easily in a distributed environment.
...
* [Label Studio](https://github.com/HumanSignal/label-studio) ⭐ 28,277 | 🐛 945 | 🌐 TypeScript | 📅 2026-09-16 - open-core multi-modal labeling platform; widely used for NLP labeling.
* [doccano](https://github.com/chakki-works/doccano) ⭐ 10,769 | 🐛 398 | 🌐 Python | 📅 2026-04-14 - doccano is free, open-source, and provides annotation features for text classification, sequence labeling and sequence to sequence
...
Modern sentence and document embeddings: see [Retrieval for NLP](#retrieval-for-nlp) (Sentence-Transformers, E5, BGE-M3, Nomic, GritLM) and [MTEB](https://github.com/embeddings-benchmark/mteb) ⭐ 3,424 | 🐛 320 | 🌐 Python | 📅 2026-09-16 for current leaderboards.
...
* [Tokenizers](https://github.com/huggingface/tokenizers) ⭐ 11,040 | 🐛 258 | 🌐 Rust | 📅 2026-09-16 - fast Rust implementations of BPE, WordPiece, Unigram.

* [Stanza](https://github.com/stanfordnlp/stanza) ⭐ 7,876 | 🐛 95 | 🌐 Python | 📅 2026-09-10 - tokenization, lemma, and morphology for 70+ languages.
...
* [spaCy](https://spacy.io/) and [Stanza](https://github.com/stanfordnlp/stanza) ⭐ 7,876 | 🐛 95 | 🌐 Python | 📅 2026-09-10 - production parsers across many languages.
...
* [BERTopic](https://github.com/MaartenGr/BERTopic) ⭐ 7,837 | 🐛 472 | 🌐 Python | 📅 2026-09-09 - clustering-based topic modeling on top of contextual embeddings; common modern default.
...
* [BGE](https://github.com/FlagOpen/FlagEmbedding) ⭐ 12,168 | 🐛 910 | 🌐 Python | 📅 2026-08-24 and [BGE-M3](https://arxiv.org/abs/2402.03216) (2024) - multilingual, multi-functionality embeddings; top of MTEB across languages.
...
* [Whisper](https://github.com/openai/whisper) ⭐ 109,218 | 🐛 148 | 🌐 Python | 📅 2026-08-31 - multilingual ASR; the modern open default.
* [Coqui TTS](https://github.com/coqui-ai/TTS) ⭐ 46,019 | 🐛 3 | 🌐 Python | 📅 2024-08-16 and [VieNeu-TTS](https://github.com/pnnbao97/VieNeu-TTS) ⭐ 2,578 | 🐛 12 | 🌐 Python | 📅 2026-09-16 - open TTS.
* [FunASR](https://github.com/modelscope/FunASR) ⭐ 20,366 | 🐛 34 | 🌐 Python | 📅 2026-09-16 - industrial-grade ASR toolkit; 170× realtime on GPU, 50+ languages, built-in VAD, punctuation, speaker diarization, and emotion detection. Includes non-autoregressive SenseVoice and LLM-based Fun-ASR-Nano models.
* [SeamlessM4T](https://github.com/facebookresearch/seamless_communication) ⭐ 11,855 | 🐛 252 | 🌐 Jupyter Notebook | 📅 2026-09-08 - unified speech and text translation.
...
* [RedPajama / RedPajama-V2](https://github.com/togethercomputer/RedPajama-Data) ⭐ 4,982 | 🐛 43 | 🌐 Python | 📅 2026-06-03 (2023-2024) - reproductions of LLaMA pretraining data; V2 is 30T tokens with quality signals.
...
* [MTEB](https://github.com/embeddings-benchmark/mteb) ⭐ 3,424 | 🐛 320 | 🌐 Python | 📅 2026-09-16 - Massive Text Embedding Benchmark; standard for sentence/document encoders.
...
* [LM Evaluation Harness](https://github.com/EleutherAI/lm-evaluation-harness) ⭐ 13,999 | 🐛 981 | 🌐 Python | 📅 2026-09-14 - unified framework for LM benchmark evaluation.
...
* [LongBench](https://github.com/THUDM/LongBench) ⭐ 1,236 | 🐛 68 | 🌐 Python | 📅 2025-01-15 - bilingual long-context benchmark across NLP tasks.
...
* [RAGAS](https://github.com/explodinggradients/ragas) ⭐ 15,752 | 🐛 593 | 🌐 Python | 📅 2026-02-24 - reference-free evaluation for RAG and QA pipelines.
* [TruthfulQA](https://github.com/sylinrl/TruthfulQA) ⭐ 945 | 🐛 21 | 🌐 Jupyter Notebook | 📅 2025-01-16 - benchmark for truthfulness in question answering.
...
* [GTE](https://huggingface.co/thenlper/gte-base), [BGE](https://github.com/FlagOpen/FlagEmbedding) ⭐ 12,168 | 🐛 910 | 🌐 Python | 📅 2026-08-24, and [Stella](https://huggingface.co/dunzhang/stella_en_1.5B_v5) - compact text embedding models near the top of MTEB.
* [SetFit](https://github.com/huggingface/setfit) ⭐ 2,807 | 🐛 155 | 🌐 Jupyter Notebook | 📅 2026-09-08 - few-shot text classification without prompts.
...
* [GGUF / llama.cpp](https://github.com/ggerganov/llama.cpp) ⭐ 128,417 | 🐛 2,480 | 🌐 C++ | 📅 2026-09-16 - portable quantized inference.
* [vLLM](https://github.com/vllm-project/vllm) ⭐ 91,910 | 🐛 8,024 | 🌐 Python | 📅 2026-09-16 - PagedAttention-based high-throughput LM serving.
* [SGLang](https://github.com/sgl-project/sglang) ⭐ 36,042 | 🐛 5,407 | 🌐 Python | 📅 2026-09-16 - structured generation and efficient serving.
...
* [PEFT](https://github.com/huggingface/peft) ⭐ 21,686 | 🐛 81 | 🌐 Python | 📅 2026-09-16 - HuggingFace library bundling LoRA, prefix tuning, IA3, and others.
...
* [TRL](https://github.com/huggingface/trl) ⭐ 19,324 | 🐛 301 | 🌐 Python | 📅 2026-09-16 - reference library for SFT, DPO, GRPO, and RLHF.
...
* [StereoSet](https://github.com/moinnadeem/StereoSet) ⭐ 205 | 🐛 11 | 🌐 Python | 📅 2022-12-08 - measuring stereotypical bias in pretrained LMs.
...
* [AraBERT](https://github.com/aub-mind/arabert) ⭐ 731 | 🐛 2 | 🌐 Python | 📅 2022-10-17 - Arabic BERT family.
* [AraELECTRA](https://aclanthology.org/2021.wanlp-1.20/) - efficient Arabic pretraining (released alongside [AraBERT](https://github.com/aub-mind/arabert) ⭐ 731 | 🐛 2 | 🌐 Python | 📅 2022-10-17).
...
* [HanLP](https://github.com/hankcs/HanLP) ⭐ 36,485 | 🐛 12 | 🌐 Python | 📅 2026-09-15 - multilingual NLP library with strong Chinese support.
* [jieba](https://github.com/fxsjy/jieba#jieba-1) ⭐ 35,152 | 🐛 700 | 🌐 Python | 📅 2024-08-21 - Python package for Chinese word segmentation.
* [SnowNLP](https://github.com/isnowfy/snownlp) ⭐ 6,629 | 🐛 44 | 🌐 Python | 📅 2020-01-19 - Python package for Chinese NLP.
...
* [DeepSeek-V3](https://github.com/deepseek-ai/DeepSeek-V3) ⭐ 104,462 | 🐛 227 | 🌐 Python | 📅 2025-08-28 - efficient open MoE model with strong Chinese.
* [Qwen 2.5 / Qwen 3](https://github.com/QwenLM/Qwen3) ⭐ 27,627 | 🐛 67 | 🌐 Python | 📅 2026-01-09 - Alibaba's open Chinese-strong LM family.
* [ChatGLM3 / GLM-4](https://github.com/THUDM/ChatGLM3) ⭐ 13,651 | 🐛 35 | 🌐 Python | 📅 2025-01-13 - Tsinghua's bilingual Chinese-English LMs.
* [Chinese-BERT-wwm](https://github.com/ymcui/Chinese-BERT-wwm) ⭐ 10,225 | 🐛 1 | 🌐 Python | 📅 2026-04-19 - whole-word masking BERT for Chinese.
...
* [funNLP](https://github.com/fighting41love/funNLP) ⭐ 83,144 | 🐛 53 | 🌐 Python | 📅 2024-05-10 - large collection of Chinese NLP tools and resources.
...
* [SEACrowd](https://github.com/SEACrowd/seacrowd-datahub) ⭐ 107 | 🐛 92 | 🌐 Python | 📅 2026-03-16 - A multilingual and multimodal data hub providing standardized datasets and benchmarks for Southeast Asian NLP (EMNLP 2024).
...
* [Garu](https://github.com/ongjin/garu) ⭐ 177 | 🐛 0 | 🌐 Python | 📅 2026-09-14 - browser-native Korean morphological analyzer running fully client-side via WebAssembly (1MB model, offline, MIT).
...
* [PyThaiNLP](https://github.com/PyThaiNLP/pythainlp) ⭐ 1,154 | 🐛 37 | 🌐 Python | 📅 2026-09-11 - Thai NLP in Python.
...
* [VieNeu-TTS](https://github.com/pnnbao97/VieNeu-TTS) ⭐ 2,578 | 🐛 12 | 🌐 Python | 📅 2026-09-16 - on-device Vietnamese text-to-speech with voice cloning.
* [underthesea](https://github.com/undertheseanlp/underthesea) ⭐ 1,808 | 🐛 37 | 🌐 Python | 📅 2026-09-15 - Vietnamese NLP toolkit.
...
* [PhoBERT](https://github.com/VinAIResearch/PhoBERT) ⭐ 805 | 🐛 4 | 📅 2026-08-04 - pretrained LM for Vietnamese.
...
* Ancient Languages: [CLTK](https://github.com/cltk/cltk) ⭐ 919 | 🐛 4 | 🌐 Python | 📅 2026-08-01: The Classical Language Toolkit is a Python library and collection of texts for doing NLP in ancient languages
...
* [awesome-llm](https://github.com/Hannibal046/Awesome-LLM) ⭐ 27,392 | 🐛 457 | 📅 2025-07-31 - general-purpose large language model resources.
* [awesome-mlops](https://github.com/visenger/awesome-mlops) ⭐ 14,215 | 🐛 45 | 📅 2024-11-21 - production ML, including LLM serving.
* [awesome-generative-ai](https://github.com/steven2358/awesome-generative-ai) ⭐ 12,645 | 🐛 673 | 📅 2026-09-16 - generative AI across modalities.
* [awesome-prompt-engineering](https://github.com/promptslab/Awesome-Prompt-Engineering) ⭐ 6,334 | 🐛 115 | 🌐 TypeScript | 📅 2026-09-16 - prompting techniques and template libraries.
* [awesome-rag](https://github.com/Danielskry/Awesome-RAG) ⭐ 1,363 | 🐛 103 | 📅 2026-09-15 - retrieval-augmented generation systems and tooling.
