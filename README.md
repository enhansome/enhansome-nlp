...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 497,968 | 🐛 104 | 📅 2026-08-18
...
*Please read the [contribution guidelines](contributing.md) before contributing. Please add your favourite NLP resource by raising a [pull request](https://github.com/keonkim/awesome-nlp/pulls) ⭐ 18,910 | 🐛 10 | 📅 2026-08-18*
...
* [Deep NLP Course](https://github.com/yandexdataschool/nlp_course) ⭐ 10,655 | 🐛 9 | 🌐 Jupyter Notebook | 📅 2026-06-01 by Yandex Data School, covering important ideas from text embedding to machine translation including sequence modeling, language models and so on.
...
* <a id="python"> **Python** - Python NLP Libraries</a> | [Back to Top](#contents)
  * [Transformers](https://github.com/huggingface/transformers) ⭐ 164,279 | 🐛 2,394 | 🌐 Python | 📅 2026-08-20 - Natural Language Processing for TensorFlow 2.0 and PyTorch.
  * [spaCy](https://github.com/explosion/spaCy) ⭐ 33,834 | 🐛 236 | 🌐 Python | 📅 2026-08-07 - Industrial strength NLP with Python and Cython :+1:
  ...
  * [Haystack](https://github.com/deepset-ai/haystack) ⭐ 26,259 | 🐛 105 | 🌐 Python | 📅 2026-08-20 - End-to-end Python framework for building natural language search interfaces to data. Leverages Transformers and the State-of-the-Art of NLP. Supports DPR, Elasticsearch, HuggingFace’s Modelhub, and much more!
  * [HuggingFace Datasets](https://github.com/huggingface/datasets) ⭐ 21,842 | 🐛 1,291 | 🌐 Python | 📅 2026-08-18 - standardized loaders and processing for thousands of NLP datasets.
  * [Sentence-Transformers](https://github.com/UKPLab/sentence-transformers) ⭐ 19,022 | 🐛 1,314 | 🌐 Python | 📅 2026-08-19 - sentence/document embeddings, semantic search, and re-ranking; current standard for retrieval-style NLP.
  ...
  * [Tokenizers](https://github.com/huggingface/tokenizers) ⭐ 10,983 | 🐛 263 | 🌐 Rust | 📅 2026-08-20 - Tokenizers optimized for Research and Production.
  ...
  * [Argilla](https://github.com/argilla-io/argilla) ⭐ 5,082 | 🐛 30 | 🌐 Python | 📅 2026-08-17 - open-source data annotation and feedback collection platform for LLM and NLP datasets.
  ...
  * [HuggingFace Evaluate](https://github.com/huggingface/evaluate) ⭐ 2,477 | 🐛 308 | 🌐 Python | 📅 2026-07-06 - reference implementations for NLP metrics.
  ...
  * [LangTest](https://github.com/JohnSnowLabs/langtest) ⭐ 560 | 🐛 5 | 🌐 Python | 📅 2026-08-20 - 60+ test types for NLP model robustness, bias, and fairness.
  ...
  * [Pearmut](https://github.com/zouharvi/pearmut) ⭐ 33 | 🐛 8 | 🌐 Python | 📅 2026-08-20 - Human annotation tool for multilingual NLP tasks, such as machine translation.
  * [python-ucto](https://github.com/proycon/python-ucto) ⭐ 32 | 🐛 6 | 🌐 Cython | 📅 2026-08-17 - Unicode-aware regular-expression based tokenizer for various languages. Python binding to C++ library, supports [FoLiA format](https://proycon.github.io/folia).
...
- <a id="scala">**Scala** - Scala NLP Libraries</a> | [Back to Top](#contents)
  * [Spark NLP](https://github.com/JohnSnowLabs/spark-nlp) ⭐ 4,158 | 🐛 29 | 🌐 Scala | 📅 2026-08-20 - Spark NLP is a natural language processing library built on top of Apache Spark ML that provides simple, performant & accurate NLP annotations for machine learning pipelines that scale easily in a distributed environment.
...
- <a id="go">**Go**</a> | [Back to Top](#contents)
  * [prose](https://github.com/jdkato/prose) ⭐ 3,084 | 🐛 20 | 🌐 Go | 📅 2026-07-29 - Text processing library supporting tokenization, part-of-speech tagging, and named-entity extraction.
  ...
  * [kagome](https://github.com/ikawaha/kagome) ⭐ 979 | 🐛 0 | 🌐 Go | 📅 2026-07-30 - Japanese morphological analyzer written in pure Go.
...
* [Label Studio](https://github.com/HumanSignal/label-studio) ⭐ 28,095 | 🐛 925 | 🌐 TypeScript | 📅 2026-08-20 - open-core multi-modal labeling platform; widely used for NLP labeling.
* [doccano](https://github.com/chakki-works/doccano) ⭐ 10,749 | 🐛 395 | 🌐 Python | 📅 2026-04-14 - doccano is free, open-source, and provides annotation features for text classification, sequence labeling and sequence to sequence
* [Argilla](https://github.com/argilla-io/argilla) ⭐ 5,082 | 🐛 30 | 🌐 Python | 📅 2026-08-17 - open-source platform for collecting human feedback, building NLP and LLM datasets, and curating preference data.
* [Potato](https://github.com/davidjurgens/potato) ⭐ 412 | 🐛 3 | 🌐 Python | 📅 2026-08-20 - Free, open-source annotation tool covering 21+ task types (classification, span, coreference, entity linking, agent trace evaluation) with built-in MACE quality control, attention checks, AI-assisted labeling, and 300+ example tasks.
...
* [Shoonya](https://github.com/AI4Bharat/Shoonya-Backend) ⭐ 28 | 🐛 46 | 🌐 Python | 📅 2026-08-20 - Shoonya is free and open source data annotation platform with wide varities of organization and workspace level management system. Shoonya is data agnostic, can be used by teams to annotate data with various level of verification stages at scale.
...
Modern sentence and document embeddings: see [Retrieval for NLP](#retrieval-for-nlp) (Sentence-Transformers, E5, BGE-M3, Nomic, GritLM) and [MTEB](https://github.com/embeddings-benchmark/mteb) ⭐ 3,399 | 🐛 348 | 🌐 Python | 📅 2026-08-19 for current leaderboards.

### Tokenization, Morphology, and Segmentation

[Back to Top](#contents)

* [SentencePiece](https://github.com/google/sentencepiece) ⭐ 12,034 | 🐛 5 | 🌐 C++ | 📅 2026-08-16 - language-agnostic subword tokenization.

* [SentencePiece](https://github.com/google/sentencepiece) ⭐ 12,034 | 🐛 5 | 🌐 C++ | 📅 2026-08-16 - language-agnostic subword tokenization (BPE and Unigram).

* [Tokenizers](https://github.com/huggingface/tokenizers) ⭐ 10,983 | 🐛 263 | 🌐 Rust | 📅 2026-08-20 - fast Rust implementations of BPE, WordPiece, Unigram.
...
* [SetFit](https://github.com/huggingface/setfit) ⭐ 2,780 | 🐛 165 | 🌐 Jupyter Notebook | 📅 2026-05-26 - few-shot text classification without prompts.
...
* [BERTopic](https://github.com/MaartenGr/BERTopic) ⭐ 7,792 | 🐛 467 | 🌐 Python | 📅 2026-08-02 - clustering-based topic modeling on top of contextual embeddings; common modern default.
...
* [BGE](https://github.com/FlagOpen/FlagEmbedding) ⭐ 12,063 | 🐛 910 | 🌐 Python | 📅 2026-08-14 and [BGE-M3](https://arxiv.org/abs/2402.03216) (2024) - multilingual, multi-functionality embeddings; top of MTEB across languages.
...
* [Whisper](https://github.com/openai/whisper) ⭐ 107,654 | 🐛 135 | 🌐 Python | 📅 2026-07-28 - multilingual ASR; the modern open default.
* [Coqui TTS](https://github.com/coqui-ai/TTS) ⭐ 45,921 | 🐛 2 | 🌐 Python | 📅 2024-08-16 and [VieNeu-TTS](https://github.com/pnnbao97/VieNeu-TTS) ⭐ 2,363 | 🐛 11 | 🌐 Python | 📅 2026-08-20 - open TTS.
* [FunASR](https://github.com/modelscope/FunASR) ⭐ 19,937 | 🐛 5 | 🌐 Python | 📅 2026-08-20 - industrial-grade ASR toolkit; 170× realtime on GPU, 50+ languages, built-in VAD, punctuation, speaker diarization, and emotion detection. Includes non-autoregressive SenseVoice and LLM-based Fun-ASR-Nano models.
...
* [RedPajama / RedPajama-V2](https://github.com/togethercomputer/RedPajama-Data) ⭐ 4,977 | 🐛 43 | 🌐 Python | 📅 2026-06-03 (2023-2024) - reproductions of LLaMA pretraining data; V2 is 30T tokens with quality signals.
...
* [MTEB](https://github.com/embeddings-benchmark/mteb) ⭐ 3,399 | 🐛 348 | 🌐 Python | 📅 2026-08-19 - Massive Text Embedding Benchmark; standard for sentence/document encoders.
* [BEIR](https://github.com/beir-cellar/beir) ⭐ 2,273 | 🐛 82 | 🌐 Python | 📅 2025-10-16 - heterogeneous IR benchmark for retrieval models.
...
* [LM Evaluation Harness](https://github.com/EleutherAI/lm-evaluation-harness) ⭐ 13,723 | 🐛 949 | 🌐 Python | 📅 2026-08-14 - unified framework for LM benchmark evaluation.
...
* [LongBench](https://github.com/THUDM/LongBench) ⭐ 1,226 | 🐛 67 | 🌐 Python | 📅 2025-01-15 - bilingual long-context benchmark across NLP tasks.
...
* [RAGAS](https://github.com/explodinggradients/ragas) ⭐ 15,392 | 🐛 562 | 🌐 Python | 📅 2026-02-24 - reference-free evaluation for RAG and QA pipelines.
...
* [GTE](https://huggingface.co/thenlper/gte-base), [BGE](https://github.com/FlagOpen/FlagEmbedding) ⭐ 12,063 | 🐛 910 | 🌐 Python | 📅 2026-08-14, and [Stella](https://huggingface.co/dunzhang/stella_en_1.5B_v5) - compact text embedding models near the top of MTEB.
* [SetFit](https://github.com/huggingface/setfit) ⭐ 2,780 | 🐛 165 | 🌐 Jupyter Notebook | 📅 2026-05-26 - few-shot text classification without prompts.
...
* [GGUF / llama.cpp](https://github.com/ggerganov/llama.cpp) ⭐ 124,799 | 🐛 2,136 | 🌐 C++ | 📅 2026-08-20 - portable quantized inference.
* [vLLM](https://github.com/vllm-project/vllm) ⭐ 89,507 | 🐛 6,819 | 🌐 Python | 📅 2026-08-20 - PagedAttention-based high-throughput LM serving.
* [SGLang](https://github.com/sgl-project/sglang) ⭐ 32,151 | 🐛 4,899 | 🌐 Python | 📅 2026-08-20 - structured generation and efficient serving.
...
* [PEFT](https://github.com/huggingface/peft) ⭐ 21,563 | 🐛 64 | 🌐 Python | 📅 2026-08-19 - HuggingFace library bundling LoRA, prefix tuning, IA3, and others.

### Instruction Tuning and Preference Optimization

* [TRL](https://github.com/huggingface/trl) ⭐ 19,109 | 🐛 273 | 🌐 Python | 📅 2026-08-20 - reference library for SFT, DPO, GRPO, and RLHF.
...
* [DeepSeek-V3](https://github.com/deepseek-ai/DeepSeek-V3) ⭐ 104,351 | 🐛 209 | 🌐 Python | 📅 2025-08-28 - efficient open MoE model with strong Chinese.
* [Qwen 2.5 / Qwen 3](https://github.com/QwenLM/Qwen3) ⭐ 27,539 | 🐛 64 | 🌐 Python | 📅 2026-01-09 - Alibaba's open Chinese-strong LM family.
...
* [funNLP](https://github.com/fighting41love/funNLP) ⭐ 82,560 | 🐛 52 | 🌐 Python | 📅 2024-05-10 - large collection of Chinese NLP tools and resources.
...
* [python-frog](https://github.com/proycon/python-frog) ⭐ 50 | 🐛 6 | 🌐 Cython | 📅 2026-08-17 - Python binding to Frog, an NLP suite for Dutch (POS tagging, lemmatization, dependency parsing, NER).
...
* [German-NLP](https://github.com/adbar/German-NLP) ⭐ 530 | 🐛 1 | 📅 2024-10-30 - curated list of open-access, open-source, and off-the-shelf resources and tools developed with a focus on German.
...
* [PyThaiNLP](https://github.com/PyThaiNLP/pythainlp) ⭐ 1,148 | 🐛 31 | 🌐 Python | 📅 2026-08-14 - Thai NLP in Python.
...
* [VieNeu-TTS](https://github.com/pnnbao97/VieNeu-TTS) ⭐ 2,363 | 🐛 11 | 🌐 Python | 📅 2026-08-20 - on-device Vietnamese text-to-speech with voice cloning.
* [underthesea](https://github.com/undertheseanlp/underthesea) ⭐ 1,803 | 🐛 22 | 🌐 Python | 📅 2026-08-20 - Vietnamese NLP toolkit.
...
* [awesome-llm](https://github.com/Hannibal046/Awesome-LLM) ⭐ 27,273 | 🐛 438 | 📅 2025-07-31 - general-purpose large language model resources.
* [awesome-mlops](https://github.com/visenger/awesome-mlops) ⭐ 14,159 | 🐛 44 | 📅 2024-11-21 - production ML, including LLM serving.
* [awesome-generative-ai](https://github.com/steven2358/awesome-generative-ai) ⭐ 12,515 | 🐛 583 | 📅 2026-08-03 - generative AI across modalities.
* [awesome-prompt-engineering](https://github.com/promptslab/Awesome-Prompt-Engineering) ⭐ 6,261 | 🐛 104 | 🌐 TypeScript | 📅 2026-08-20 - prompting techniques and template libraries.
